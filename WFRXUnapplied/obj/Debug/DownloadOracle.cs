...
[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAD37929B34656")]
[System.ComponentModel.ToolboxItemAttribute(false)]
public sealed class DownloadOracle : OpenSpan.Automation.Automator
{
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAD37929B34656\\EntryPoint-8DAD37929B6954A")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAD37929B34656\\Pause-8DAD3905F0532B1")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAD37929B34656\\JsonUtils-8DADC2ED8EE700A")]
	...
	public DownloadOracle()
	{
		...
		// Setup field members
		// 
		System.ComponentModel.ComponentResourceManager _resources_ = new System.ComponentModel.ComponentResourceManager(typeof(DownloadOracle));
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656");
		// 
		// Set component Ids
		// 
		this.SetId(this.entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DAD37929B6954A"));
		this.SetId(this.exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAD37929B6A237"));
		this.SetId(this.exitPoint2, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAD37929B6A446"));
		this.SetId(this.exitPoint3, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAD37929B8EE1D"));
		this.SetId(this.labelHost2, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAD37929B8FDD8"));
		this.SetId(this.labelHost3, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAD37929BB60DF"));
		this.SetId(this.labelHost1, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAD37929BB8776"));
		this.SetId(this.tryHost1, new OpenSpan.Design.ComponentIdentity("TryHost-8DAD37929BDB7AE"));
		this.SetId(this.catchHost1, new OpenSpan.Design.ComponentIdentity("CatchHost-8DAD37929BDD11E"));
		this.SetId(this.connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DAD3904D5DC80D"));
		this.SetId(this.connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAD3904EC037BA"));
		this.SetId(this.connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAD3904F802097"));
		this.SetId(this.pause1, new OpenSpan.Design.ComponentIdentity("Pause-8DAD3905F0532B1"));
		this.SetId(this.connectableMethod3, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAD390616AC55C"));
		this.SetId(this.connectableMethod4, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAD3911D9E0C28"));
		this.SetId(this.catchHost2, new OpenSpan.Design.ComponentIdentity("CatchHost-8DAD39126C124E4"));
		this.SetId(this.jumpHost1, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAD39129F0A0AC"));
		this.SetId(this.jumpHost2, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAD3912B1E0072"));
		this.SetId(this.jumpHost3, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAD391379C356C"));
		this.SetId(this.jumpHost4, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAD3913A6BD562"));
		this.SetId(this.connectableMethod5, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2E67D56255"));
		this.SetId(this.connectableMethod6, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2E6EF0402B"));
		this.SetId(this.connectableMethod7, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2E76A3FB15"));
		this.SetId(this.connectableMethod8, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2E794DEB9B"));
		this.SetId(this.connectableMethod9, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2E827AE475"));
		this.SetId(this.connectableMethod10, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2E85566477"));
		this.SetId(this.jumpHost5, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2E89CC2549"));
		this.SetId(this.jumpHost6, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2E8AF30983"));
		this.SetId(this.jumpHost7, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2E8BC8BB4C"));
		this.SetId(this.labelHost4, new OpenSpan.Design.ComponentIdentity("LabelHost-8DADC2EA482CCCF"));
		this.SetId(this.tryHost2, new OpenSpan.Design.ComponentIdentity("TryHost-8DADC2EAAC75DA1"));
		this.SetId(this.jumpHost8, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2EB1EE034C"));
		this.SetId(this.connectableMethod11, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2EC2633AA9"));
		this.SetId(this.connectableMethod12, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2ED4D7E733"));
		this.SetId(this.jsonUtils1, new OpenSpan.Design.ComponentIdentity("JsonUtils-8DADC2ED8EE700A"));
		this.SetId(this.connectableMethod13, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2EFDB54D0A"));
		this.SetId(this.connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DADC2F04A83D1E"));
		this.SetId(this.jumpHost9, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2F19694FC3"));
		this.SetId(this.connectableMethod14, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2F39CC1C4F"));
		this.SetId(this.connectableProperties3, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DADC2F39CE7D07"));
		this.SetId(this.jumpHost10, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2F39D0DF3C"));
		this.SetId(this.jumpHost11, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2F4A2133D5"));
		this.SetId(this.connectableMethod16, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2F7D69521A"));
		this.SetId(this.catchHost3, new OpenSpan.Design.ComponentIdentity("CatchHost-8DADC2F8F2F39CB"));
		this.SetId(this.jumpHost13, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2F8F319ABD"));
		this.SetId(this.connectableMethod19, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC30C4BBC6E3"));
		this.SetId(this.connectableProperties4, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DADC55EFB19573"));
		this.SetId(this.connectableMethod15, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC5661960FC4"));
		this.SetId(this.connectableMethod20, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC56F074D185"));
		// 
		// DownloadOracle
		// 
		ComponentInfo.CodeDomData = _resources_.GetString("_DownloadOracle_1_");
		this.DocumentScale = 0.75844F;
		dynamicmethodinfo1.BlockTypeName = "OpenSpan.Automation.Design.ConnectionBlocks.EntryPointExecuteBlock";
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_DownloadOracle_2_");
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_DownloadOracle_3_");
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_DownloadOracle_4_");
		...
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_DownloadOracle_5_");
		...
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_DownloadOracle_6_");
		...
		this.entryPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\EntryPoint-8DAD37929B6954A");
		...
		dynamicpropertyinfo5.CodeDomData = _resources_.GetString("_DownloadOracle_7_");
		...
		dynamicpropertyinfo6.CodeDomData = _resources_.GetString("_DownloadOracle_8_");
		...
		dynamicpropertyinfo7.CodeDomData = _resources_.GetString("_DownloadOracle_9_");
		...
		dynamicpropertyinfo8.CodeDomData = _resources_.GetString("_DownloadOracle_10_");
		...
		this.exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\EntryPoint-8DAD37929B6954A");
		// 
		// exitPoint2
		// 
		...
		dynamicpropertyinfo9.CodeDomData = _resources_.GetString("_DownloadOracle_7_");
		...
		dynamicpropertyinfo10.CodeDomData = _resources_.GetString("_DownloadOracle_8_");
		...
		dynamicpropertyinfo11.CodeDomData = _resources_.GetString("_DownloadOracle_9_");
		...
		dynamicpropertyinfo12.CodeDomData = _resources_.GetString("_DownloadOracle_10_");
		...
		this.exitPoint2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\EntryPoint-8DAD37929B6954A");
		// 
		// exitPoint3
		// 
		...
		dynamicpropertyinfo13.CodeDomData = _resources_.GetString("_DownloadOracle_7_");
		...
		dynamicpropertyinfo14.CodeDomData = _resources_.GetString("_DownloadOracle_8_");
		...
		dynamicpropertyinfo15.CodeDomData = _resources_.GetString("_DownloadOracle_9_");
		...
		dynamicpropertyinfo16.CodeDomData = _resources_.GetString("_DownloadOracle_10_");
		...
		this.exitPoint3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\EntryPoint-8DAD37929B6954A");
		// 
		// labelHost2
		// 
		...
		dynamicmethodinfo2.CodeDomData = _resources_.GetString("_DownloadOracle_11_");
		...
		dynamicpropertyinfo17.CodeDomData = _resources_.GetString("_DownloadOracle_12_");
		...
		dynamicpropertyinfo18.CodeDomData = _resources_.GetString("_DownloadOracle_13_");
		dynamicmethodinfo3.Source = "";
		dynamicmethodinfo3.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo3.CodeDomData = _resources_.GetString("_DownloadOracle_14_");
		...
		dynamicpropertyinfo19.CodeDomData = _resources_.GetString("_DownloadOracle_15_");
		...
		dynamicmethodinfo4.CodeDomData = _resources_.GetString("_DownloadOracle_16_");
		...
		this.tryHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\TryHost-8DAD37929BDB7AE");
		// 
		// catchHost1
		// 
		...
		dynamiceventinfo1.CodeDomData = _resources_.GetString("_DownloadOracle_17_");
		...
		dynamicpropertyinfo20.CodeDomData = _resources_.GetString("_DownloadOracle_18_");
		...
		this.catchHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\CatchHost-8DAD37929BDD11E");
		// 
		...
		memberprototype2.MemberName = "StartPage";
		...
		this.connectableMethod2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F");
		...
		this.connectableMethod3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\Pause-8DAD3905F0532B1");
		memberprototype5.DefaultValue = null;
		memberprototype5.MemberName = "Sleep";
		...
		dynamicpropertyinfo21.CodeDomData = _resources_.GetString("_DownloadOracle_19_");
		this.connectableMethod4.DynamicMembers.Add(dynamicpropertyinfo21);
		this.connectableMethod4.ExceptionsHandled = false;
		this.connectableMethod4.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.Image";
		this.connectableMethod4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F\\Image-8DAD3903432755C");
		...
		parameterprototype2.DefaultValue = "120000";
		...
		this.catchHost2.CaughtLinkIDs.Add(76);
		this.catchHost2.CaughtLinkIDs.Add(21);
		this.catchHost2.CaughtLinkIDs.Add(23);
		this.catchHost2.CaughtLinkIDs.Add(24);
		this.catchHost2.CaughtLinkIDs.Add(25);
		...
		dynamiceventinfo2.CodeDomData = _resources_.GetString("_DownloadOracle_17_");
		...
		dynamicpropertyinfo22.CodeDomData = _resources_.GetString("_DownloadOracle_18_");
		...
		this.catchHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\CatchHost-8DAD39126C124E4");
		// 
		// jumpHost1
		// 
		...
		this.jumpHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929BB60DF");
		...
		parameterprototype4.ParamName = "_param2";
		...
		this.jumpHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929B8FDD8");
		...
		parameterprototype5.DefaultValue = "Could not login to download Oracle. ";
		...
		this.jumpHost3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929BB8776");
		...
		this.jumpHost4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929BB60DF");
		...
		memberprototype10.Signature.ParameterPrototype.Add(parameterprototype7);
		...
		dynamicpropertyinfo23.CodeDomData = _resources_.GetString("_DownloadOracle_19_");
		this.connectableMethod5.DynamicMembers.Add(dynamicpropertyinfo23);
		this.connectableMethod5.ExceptionsHandled = false;
		this.connectableMethod5.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.WebControl";
		this.connectableMethod5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F\\WebControl-8DADC2D5556E827");
		memberprototype11.DefaultValue = null;
		memberprototype11.MemberName = "WaitForCreate";
		...
		this.connectableMethod6.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F\\WebControl-8DADC2D5556E827");
		...
		dynamicpropertyinfo24.CodeDomData = _resources_.GetString("_DownloadOracle_19_");
		this.connectableMethod7.DynamicMembers.Add(dynamicpropertyinfo24);
		this.connectableMethod7.ExceptionsHandled = false;
		this.connectableMethod7.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.WebControl";
		this.connectableMethod7.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F\\WebControl-8DADC2D9C05F751");
		memberprototype13.DefaultValue = null;
		memberprototype13.MemberName = "WaitForCreate";
		...
		this.connectableMethod8.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.WebControl";
		this.connectableMethod8.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F\\WebControl-8DADC2D9C05F751");
		memberprototype14.DefaultValue = null;
		memberprototype14.MemberName = "PerformClick";
		...
		dynamicpropertyinfo25.CodeDomData = _resources_.GetString("_DownloadOracle_19_");
		this.connectableMethod9.DynamicMembers.Add(dynamicpropertyinfo25);
		this.connectableMethod9.ExceptionsHandled = false;
		this.connectableMethod9.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.WebControl";
		this.connectableMethod9.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F\\WebControl-8DADC2DC497A2A6");
		...
		this.connectableMethod10.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.WebControl";
		this.connectableMethod10.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F\\WebControl-8DADC2DC497A2A6");
		memberprototype16.DefaultValue = null;
		memberprototype16.MemberName = "PerformClick";
		...
		this.jumpHost5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929B8FDD8");
		...
		this.jumpHost6.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929B8FDD8");
		...
		this.jumpHost7.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929B8FDD8");
		...
		parameterprototype10.DefaultValue = "ReceiptsSummary link did not create. ";
		parameterprototype10.ParamName = "_param1";
		parameterprototype10.Position = 0;
		parameterprototype10.TypeName = "System.String";
		memberprototype19.Signature.ParameterPrototype.Add(parameterprototype10);
		...
		this.labelHost4.LabelName = "SaveDownload";
		// 
		// tryHost2
		// 
		...
		this.tryHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\TryHost-8DADC2EAAC75DA1");
		// 
		// jumpHost8
		// 
		...
		this.jumpHost8.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DADC2EA482CCCF");
		...
		// connectableMethod11
		// 
		this.connectableMethod11.DisplayName = "<Start>";
		this.connectableMethod11.ExceptionsHandled = false;
		this.connectableMethod11.InstanceTypeName = "OpenSpan.Adapters.Windows.WindowsAdapter";
		this.connectableMethod11.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC2DEB29BBB7");
		memberprototype21.DefaultValue = null;
		memberprototype21.MemberName = "Start";
		...
		this.connectableMethod11.MemberPrototypes.Add(memberprototype21);
		this.connectableMethod11.ParamsLength = 0;
		this.connectableMethod11.SerializedParamsDefaultValues = "";
		// 
		// connectableMethod12
		// 
		this.connectableMethod12.DisplayName = "<WaitForCreate>";
		...
		dynamicpropertyinfo26.CodeDomData = _resources_.GetString("_DownloadOracle_19_");
		this.connectableMethod12.DynamicMembers.Add(dynamicpropertyinfo26);
		this.connectableMethod12.ExceptionsHandled = false;
		this.connectableMethod12.InstanceTypeName = "OpenSpan.Adapters.Controls.TextBox";
		this.connectableMethod12.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC2DEB29BBB7\\TextBox-8DADC2E4113F3C8");
		memberprototype22.DefaultValue = null;
		memberprototype22.MemberName = "WaitForCreate";
		...
		this.connectableMethod12.MemberPrototypes.Add(memberprototype22);
		...
		dynamicpropertyinfo27.CodeDomData = _resources_.GetString("_DownloadOracle_19_");
		this.connectableMethod13.DynamicMembers.Add(dynamicpropertyinfo27);
		this.connectableMethod13.ExceptionsHandled = false;
		this.connectableMethod13.InstanceTypeName = "OpenSpan.Controls.JsonUtils";
		this.connectableMethod13.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\JsonUtils-8DADC2ED8EE700A");
		...
		parameterprototype12.DefaultValue = "OracleURL";
		...
		memberprototype23.Signature.ParameterPrototype.Add(parameterprototype13);
		memberprototype23.Signature.ReturnType = "System.Boolean";
		memberprototype23.TypeName = "System.Boolean";
		this.connectableMethod13.MemberPrototypes.Add(memberprototype23);
		...
		this.jumpHost9.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929B8FDD8");
		...
		parameterprototype14.DefaultValue = "Could not get Oracle URL from Reference Data file. ";
		parameterprototype14.ParamName = "_param1";
		parameterprototype14.Position = 0;
		parameterprototype14.TypeName = "System.String";
		memberprototype25.Signature.ParameterPrototype.Add(parameterprototype14);
		...
		dynamicpropertyinfo28.CodeDomData = _resources_.GetString("_DownloadOracle_19_");
		this.connectableMethod14.DynamicMembers.Add(dynamicpropertyinfo28);
		this.connectableMethod14.ExceptionsHandled = false;
		this.connectableMethod14.InstanceTypeName = "OpenSpan.Controls.JsonUtils";
		this.connectableMethod14.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\JsonUtils-8DADC2ED8EE700A");
		...
		parameterprototype16.DefaultValue = "DownloadPath";
		...
		memberprototype26.Signature.ParameterPrototype.Add(parameterprototype16);
		memberprototype26.Signature.ParameterPrototype.Add(parameterprototype17);
		...
		this.jumpHost10.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929B8FDD8");
		...
		parameterprototype18.DefaultValue = "Could not get Download Path from Reference Data file. ";
		...
		this.jumpHost10.MemberPrototypes.Add(memberprototype28);
		...
		this.jumpHost11.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929B8FDD8");
		...
		parameterprototype19.DefaultValue = "txtTextBox did not create. ";
		...
		// connectableMethod16
		// 
		this.connectableMethod16.DisplayName = "<Sleep>";
		this.connectableMethod16.ExceptionsHandled = false;
		this.connectableMethod16.InstanceTypeName = "OpenSpan.Controls.Pause";
		this.connectableMethod16.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\Pause-8DAD3905F0532B1");
		...
		parameterprototype20.DefaultValue = "1000";
		...
		this.connectableMethod16.MemberPrototypes.Add(memberprototype30);
		...
		this.catchHost3.CaughtLinkIDs.Add(88);
		this.catchHost3.CaughtLinkIDs.Add(108);
		this.catchHost3.CaughtLinkIDs.Add(93);
		this.catchHost3.CaughtLinkIDs.Add(112);
		this.catchHost3.CaughtLinkIDs.Add(110);
		this.catchHost3.CaughtLinkIDs.Add(106);
		...
		dynamiceventinfo3.CodeDomData = _resources_.GetString("_DownloadOracle_17_");
		...
		dynamicpropertyinfo29.CodeDomData = _resources_.GetString("_DownloadOracle_18_");
		this.catchHost3.DynamicMembers.Add(dynamiceventinfo3);
		this.catchHost3.DynamicMembers.Add(dynamicpropertyinfo29);
		this.catchHost3.ExceptionsHandled = false;
		this.catchHost3.InstanceTypeName = "OpenSpan.Automation.CatchHost";
		this.catchHost3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\CatchHost-8DADC2F8F2F39CB");
		// 
		// jumpHost13
		// 
		...
		this.jumpHost13.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929BB60DF");
		...
		memberprototype31.Signature.ParameterPrototype.Add(parameterprototype21);
		...
		this.jumpHost13.MemberPrototypes.Add(memberprototype31);
		this.jumpHost13.ParamsLength = 0;
		this.jumpHost13.SerializedParamsDefaultValues = "";
		// 
		// connectableMethod19
		// 
		this.connectableMethod19.DisplayName = "<Stop>";
		this.connectableMethod19.ExceptionsHandled = false;
		this.connectableMethod19.InstanceTypeName = "OpenSpan.Adapters.Windows.WindowsAdapter";
		this.connectableMethod19.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC2DEB29BBB7");
		memberprototype32.DefaultValue = null;
		memberprototype32.MemberName = "Stop";
		...
		this.connectableProperties4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC2DEB29BBB7\\TextBox-8DADC2E4113F3C8");
		memberprototype33.DefaultValue = null;
		memberprototype33.MemberName = "Text";
		...
		this.connectableProperties4.MemberPrototypes.Add(memberprototype33);
		// 
		// connectableMethod15
		// 
		this.connectableMethod15.DisplayName = "<Sleep>";
		this.connectableMethod15.ExceptionsHandled = false;
		this.connectableMethod15.InstanceTypeName = "OpenSpan.Controls.Pause";
		this.connectableMethod15.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\Pause-8DAD3905F0532B1");
		...
		parameterprototype23.DefaultValue = "1000";
		parameterprototype23.ParamName = "milliseconds";
		parameterprototype23.Position = 0;
		parameterprototype23.TypeName = "System.Int32";
		...
		// connectableMethod20
		// 
		this.connectableMethod20.DisplayName = "<SendKeys>";
		this.connectableMethod20.ExceptionsHandled = false;
		this.connectableMethod20.InstanceTypeName = "OpenSpan.Adapters.Controls.TextBox";
		this.connectableMethod20.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC2DEB29BBB7\\TextBox-8DADC2E4113F3C8");
		memberprototype35.DefaultValue = null;
		memberprototype35.MemberName = "SendKeys";
		...
		parameterprototype24.DefaultValue = "{ENTER}";
		parameterprototype24.ParamName = "keys";
		...
		parameterprototype25.DefaultValue = "True";
		parameterprototype25.ParamName = "focus";
		parameterprototype25.Position = 1;
		parameterprototype25.TypeName = "System.Boolean";
		memberprototype35.Signature.ParameterPrototype.Add(parameterprototype24);
		memberprototype35.Signature.ParameterPrototype.Add(parameterprototype25);
		...
		// 
		this.CodeDomData = _resources_.GetString("_DownloadOracle_20_");
		// 
		// Add components
		// 
	...
	internal OpenSpan.Automation.EntryPoint Create_entryPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DAD37929B6954A"));
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAD37929B6A237"));
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_DownloadOracle_7_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo2 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_DownloadOracle_8_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo3 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo3.IsSerializable = true;
		dynamicpropertyinfo3.NoInputConvesion = false;
		dynamicpropertyinfo3.Source = "";
		dynamicpropertyinfo3.ValidateConnectionCallback = null;
		dynamicpropertyinfo3.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_DownloadOracle_9_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo4 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo4.IsSerializable = true;
		dynamicpropertyinfo4.NoInputConvesion = false;
		dynamicpropertyinfo4.Source = "";
		dynamicpropertyinfo4.ValidateConnectionCallback = null;
		dynamicpropertyinfo4.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_DownloadOracle_10_");
		...
		dynamicpropertyinfo5.CodeDomData = _resources_.GetString("_DownloadOracle_3_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo6 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo6.IsSerializable = true;
		dynamicpropertyinfo6.NoInputConvesion = false;
		dynamicpropertyinfo6.Source = "";
		dynamicpropertyinfo6.ValidateConnectionCallback = null;
		dynamicpropertyinfo6.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo6.CodeDomData = _resources_.GetString("_DownloadOracle_4_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo7 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo7.IsSerializable = true;
		dynamicpropertyinfo7.NoInputConvesion = false;
		dynamicpropertyinfo7.Source = "";
		dynamicpropertyinfo7.ValidateConnectionCallback = null;
		dynamicpropertyinfo7.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo7.CodeDomData = _resources_.GetString("_DownloadOracle_5_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo8 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo8.IsSerializable = true;
		dynamicpropertyinfo8.NoInputConvesion = false;
		dynamicpropertyinfo8.Source = "";
		dynamicpropertyinfo8.ValidateConnectionCallback = null;
		dynamicpropertyinfo8.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo8.CodeDomData = _resources_.GetString("_DownloadOracle_6_");
		...
		exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\EntryPoint-8DAD37929B6954A");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DAD37929B6954A"));
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint2, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAD37929B6A446"));
		...
		exitPoint2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\EntryPoint-8DAD37929B6954A");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DAD37929B6954A"));
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint3, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAD37929B8EE1D"));
		...
		exitPoint3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\EntryPoint-8DAD37929B6954A");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DAD37929B6954A"));
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost2, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAD37929B8FDD8"));
		labelHost2.DisplayName = "Failed";
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_DownloadOracle_11_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_DownloadOracle_12_");
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost3, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAD37929BB60DF"));
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_DownloadOracle_13_");
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_DownloadOracle_14_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo2 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_DownloadOracle_15_");
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost1, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAD37929BB8776"));
		labelHost1.DisplayName = "Success";
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_DownloadOracle_16_");
	...
	internal OpenSpan.Automation.Design.TryHost Create_tryHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(tryHost1, new OpenSpan.Design.ComponentIdentity("TryHost-8DAD37929BDB7AE"));
		tryHost1.DisplayName = "TRY";
		tryHost1.ExceptionsHandled = false;
		tryHost1.InstanceTypeName = "OpenSpan.Automation.Design.TryHost";
		tryHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\TryHost-8DAD37929BDB7AE");
		// 
		// Result
		// 
		return tryHost1;
	...
	internal OpenSpan.Automation.CatchHost Create_catchHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(catchHost1, new OpenSpan.Design.ComponentIdentity("CatchHost-8DAD37929BDD11E"));
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_DownloadOracle_18_");
		...
		catchHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\CatchHost-8DAD37929BDD11E");
		// 
		// Result
		// 
		return catchHost1;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DAD3904D5DC80D"));
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAD3904EC037BA"));
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAD3904F802097"));
		...
		connectableMethod2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Controls.Pause Create_pause1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(pause1, new OpenSpan.Design.ComponentIdentity("Pause-8DAD3905F0532B1"));
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod3, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAD390616AC55C"));
		connectableMethod3.DisplayName = "<Sleep>";
		connectableMethod3.ExceptionsHandled = false;
		connectableMethod3.InstanceTypeName = "OpenSpan.Controls.Pause";
		connectableMethod3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\Pause-8DAD3905F0532B1");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod4(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod4, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAD3911D9E0C28"));
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_DownloadOracle_19_");
		connectableMethod4.DynamicMembers.Add(dynamicpropertyinfo1);
		connectableMethod4.ExceptionsHandled = false;
		connectableMethod4.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.Image";
		connectableMethod4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F\\Image-8DAD3903432755C");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.CatchHost Create_catchHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(catchHost2, new OpenSpan.Design.ComponentIdentity("CatchHost-8DAD39126C124E4"));
		catchHost2.CaughtLinkIDs.Add(20);
		catchHost2.CaughtLinkIDs.Add(76);
		catchHost2.CaughtLinkIDs.Add(21);
		catchHost2.CaughtLinkIDs.Add(23);
		catchHost2.CaughtLinkIDs.Add(24);
		catchHost2.CaughtLinkIDs.Add(25);
		...
		catchHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\CatchHost-8DAD39126C124E4");
		// 
		// Result
		// 
		return catchHost2;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost1, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAD39129F0A0AC"));
		jumpHost1.DisplayName = "<GoToLabel>";
		jumpHost1.ExceptionsHandled = false;
		jumpHost1.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929BB60DF");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost2, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAD3912B1E0072"));
		jumpHost2.DisplayName = "<GoToLabel>";
		jumpHost2.ExceptionsHandled = false;
		jumpHost2.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929B8FDD8");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		parameterprototype1.CanWrite = true;
		parameterprototype1.DefaultSet = true;
		parameterprototype1.DefaultValue = "Could not login to download Oracle. ";
		parameterprototype1.ParamName = "_param1";
		parameterprototype1.Position = 0;
		parameterprototype1.TypeName = "System.String";
		memberprototype1.Signature.ParameterPrototype.Add(parameterprototype1);
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost3, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAD391379C356C"));
		jumpHost3.DisplayName = "<GoToLabel>";
		jumpHost3.ExceptionsHandled = false;
		jumpHost3.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929BB8776");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost4(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost4, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAD3913A6BD562"));
		jumpHost4.DisplayName = "<GoToLabel>";
		jumpHost4.ExceptionsHandled = false;
		jumpHost4.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929BB60DF");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod5(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod5, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2E67D56255"));
		...
		connectableMethod5.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.WebControl";
		connectableMethod5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F\\WebControl-8DADC2D5556E827");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "WaitForCreate";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod6(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod6, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2E6EF0402B"));
		...
		connectableMethod6.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F\\WebControl-8DADC2D5556E827");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod7(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod7, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2E76A3FB15"));
		...
		connectableMethod7.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.WebControl";
		connectableMethod7.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F\\WebControl-8DADC2D9C05F751");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "WaitForCreate";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod8(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod8, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2E794DEB9B"));
		connectableMethod8.DisplayName = "<PerformClick>";
		connectableMethod8.ExceptionsHandled = false;
		connectableMethod8.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.WebControl";
		connectableMethod8.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F\\WebControl-8DADC2D9C05F751");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "PerformClick";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod9(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod9, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2E827AE475"));
		...
		connectableMethod9.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.WebControl";
		connectableMethod9.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F\\WebControl-8DADC2DC497A2A6");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "WaitForCreate";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod10(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod10, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2E85566477"));
		connectableMethod10.DisplayName = "<PerformClick>";
		connectableMethod10.ExceptionsHandled = false;
		connectableMethod10.InstanceTypeName = "OpenSpan.Adapters.Web.WebBase.Controls.WebControl";
		connectableMethod10.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("UniversalWebAdapter-8DAD38F4A4E996F\\WebControl-8DADC2DC497A2A6");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "PerformClick";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost5(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost5, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2E89CC2549"));
		jumpHost5.DisplayName = "<GoToLabel>";
		jumpHost5.ExceptionsHandled = false;
		jumpHost5.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929B8FDD8");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		parameterprototype1.CanWrite = true;
		parameterprototype1.DefaultSet = true;
		parameterprototype1.DefaultValue = "ARManager link did not create. ";
		parameterprototype1.ParamName = "_param1";
		parameterprototype1.Position = 0;
		parameterprototype1.TypeName = "System.String";
		memberprototype1.Signature.ParameterPrototype.Add(parameterprototype1);
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost6(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost6, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2E8AF30983"));
		jumpHost6.DisplayName = "<GoToLabel>";
		jumpHost6.ExceptionsHandled = false;
		jumpHost6.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost6.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929B8FDD8");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		parameterprototype1.CanWrite = true;
		parameterprototype1.DefaultSet = true;
		parameterprototype1.DefaultValue = "Receipts link did not create. ";
		parameterprototype1.ParamName = "_param1";
		parameterprototype1.Position = 0;
		parameterprototype1.TypeName = "System.String";
		memberprototype1.Signature.ParameterPrototype.Add(parameterprototype1);
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost7(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost7, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2E8BC8BB4C"));
		jumpHost7.DisplayName = "<GoToLabel>";
		jumpHost7.ExceptionsHandled = false;
		jumpHost7.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost7.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929B8FDD8");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		parameterprototype1.CanWrite = true;
		parameterprototype1.DefaultSet = true;
		parameterprototype1.DefaultValue = "ReceiptsSummary link did not create. ";
		parameterprototype1.ParamName = "_param1";
		parameterprototype1.Position = 0;
		parameterprototype1.TypeName = "System.String";
		memberprototype1.Signature.ParameterPrototype.Add(parameterprototype1);
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost4(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost4, new OpenSpan.Design.ComponentIdentity("LabelHost-8DADC2EA482CCCF"));
		labelHost4.DisplayName = "SaveDownload";
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_DownloadOracle_16_");
		...
		labelHost4.LabelName = "SaveDownload";
		// 
		// Result
		// 
		return labelHost4;
	...
	internal OpenSpan.Automation.Design.TryHost Create_tryHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(tryHost2, new OpenSpan.Design.ComponentIdentity("TryHost-8DADC2EAAC75DA1"));
		tryHost2.DisplayName = "TRY";
		tryHost2.ExceptionsHandled = false;
		tryHost2.InstanceTypeName = "OpenSpan.Automation.Design.TryHost";
		tryHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\TryHost-8DADC2EAAC75DA1");
		// 
		// Result
		// 
		return tryHost2;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost8(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost8, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2EB1EE034C"));
		jumpHost8.DisplayName = "<GoToLabel>";
		jumpHost8.ExceptionsHandled = false;
		jumpHost8.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost8.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DADC2EA482CCCF");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod11(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod11, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2EC2633AA9"));
		connectableMethod11.DisplayName = "<Start>";
		connectableMethod11.ExceptionsHandled = false;
		connectableMethod11.InstanceTypeName = "OpenSpan.Adapters.Windows.WindowsAdapter";
		connectableMethod11.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC2DEB29BBB7");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Start";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod12(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod12, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2ED4D7E733"));
		connectableMethod12.DisplayName = "<WaitForCreate>";
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		...
		connectableMethod12.InstanceTypeName = "OpenSpan.Adapters.Controls.TextBox";
		connectableMethod12.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC2DEB29BBB7\\TextBox-8DADC2E4113F3C8");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "WaitForCreate";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Controls.JsonUtils Create_jsonUtils1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jsonUtils1, new OpenSpan.Design.ComponentIdentity("JsonUtils-8DADC2ED8EE700A"));
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod13(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod13, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2EFDB54D0A"));
		...
		connectableMethod13.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\JsonUtils-8DADC2ED8EE700A");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		...
		parameterprototype2.CanWrite = true;
		parameterprototype2.DefaultSet = true;
		parameterprototype2.DefaultValue = "OracleURL";
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DADC2F04A83D1E"));
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost9(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost9, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2F19694FC3"));
		jumpHost9.DisplayName = "<GoToLabel>";
		jumpHost9.ExceptionsHandled = false;
		jumpHost9.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost9.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929B8FDD8");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		parameterprototype1.CanWrite = true;
		parameterprototype1.DefaultSet = true;
		parameterprototype1.DefaultValue = "Could not get Oracle URL from Reference Data file. ";
		parameterprototype1.ParamName = "_param1";
		parameterprototype1.Position = 0;
		parameterprototype1.TypeName = "System.String";
		memberprototype1.Signature.ParameterPrototype.Add(parameterprototype1);
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod14(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod14, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2F39CC1C4F"));
		...
		connectableMethod14.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\JsonUtils-8DADC2ED8EE700A");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GetValueFromJSON";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties3, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DADC2F39CE7D07"));
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost10(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost10, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2F39D0DF3C"));
		...
		jumpHost10.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929B8FDD8");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		parameterprototype1.CanWrite = true;
		parameterprototype1.DefaultSet = true;
		parameterprototype1.DefaultValue = "Could not get Download Path from Reference Data file. ";
		parameterprototype1.ParamName = "_param1";
		parameterprototype1.Position = 0;
		parameterprototype1.TypeName = "System.String";
		memberprototype1.Signature.ParameterPrototype.Add(parameterprototype1);
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost11(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost11, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2F4A2133D5"));
		...
		jumpHost11.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929B8FDD8");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		parameterprototype1.CanWrite = true;
		parameterprototype1.DefaultSet = true;
		parameterprototype1.DefaultValue = "txtTextBox did not create. ";
		parameterprototype1.ParamName = "_param1";
		parameterprototype1.Position = 0;
		parameterprototype1.TypeName = "System.String";
		memberprototype1.Signature.ParameterPrototype.Add(parameterprototype1);
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod16(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod16, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC2F7D69521A"));
		connectableMethod16.DisplayName = "<Sleep>";
		connectableMethod16.ExceptionsHandled = false;
		connectableMethod16.InstanceTypeName = "OpenSpan.Controls.Pause";
		connectableMethod16.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\Pause-8DAD3905F0532B1");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Sleep";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.CatchHost Create_catchHost3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(catchHost3, new OpenSpan.Design.ComponentIdentity("CatchHost-8DADC2F8F2F39CB"));
		catchHost3.CaughtLinkIDs.Add(70);
		catchHost3.CaughtLinkIDs.Add(83);
		catchHost3.CaughtLinkIDs.Add(88);
		catchHost3.CaughtLinkIDs.Add(108);
		catchHost3.CaughtLinkIDs.Add(93);
		catchHost3.CaughtLinkIDs.Add(112);
		catchHost3.CaughtLinkIDs.Add(110);
		catchHost3.CaughtLinkIDs.Add(106);
		...
		catchHost3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\CatchHost-8DADC2F8F2F39CB");
		// 
		// Result
		// 
		return catchHost3;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost13(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost13, new OpenSpan.Design.ComponentIdentity("JumpHost-8DADC2F8F319ABD"));
		...
		jumpHost13.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\LabelHost-8DAD37929BB60DF");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod19(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod19, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC30C4BBC6E3"));
		connectableMethod19.DisplayName = "<Stop>";
		connectableMethod19.ExceptionsHandled = false;
		connectableMethod19.InstanceTypeName = "OpenSpan.Adapters.Windows.WindowsAdapter";
		connectableMethod19.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC2DEB29BBB7");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Stop";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties4(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties4, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DADC55EFB19573"));
		...
		connectableProperties4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC2DEB29BBB7\\TextBox-8DADC2E4113F3C8");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod15(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod15, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC5661960FC4"));
		connectableMethod15.DisplayName = "<Sleep>";
		connectableMethod15.ExceptionsHandled = false;
		connectableMethod15.InstanceTypeName = "OpenSpan.Controls.Pause";
		connectableMethod15.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD37929B34656\\Pause-8DAD3905F0532B1");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Sleep";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod20(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod20, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DADC56F074D185"));
		connectableMethod20.DisplayName = "<SendKeys>";
		connectableMethod20.ExceptionsHandled = false;
		connectableMethod20.InstanceTypeName = "OpenSpan.Adapters.Controls.TextBox";
		connectableMethod20.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC2DEB29BBB7\\TextBox-8DADC2E4113F3C8");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
