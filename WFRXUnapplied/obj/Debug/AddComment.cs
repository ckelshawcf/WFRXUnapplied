...
[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAF22ED899211A")]
[System.ComponentModel.ToolboxItemAttribute(false)]
public sealed class AddComment : OpenSpan.Automation.Automator
{
	...
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAF22ED899211A\\EntryPoint-8DAF22F17E89674")]
	public OpenSpan.Automation.EntryPoint entryPoint1;
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAF22ED899211A\\HiddenTypeProxy-8DAF22F19BEEE8E")]
	public OpenSpan.Automation.HiddenTypeProxy hiddenTypeProxy1;
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAF22ED899211A\\HiddenTypeProxy-8DAF22F1E4D04C2")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC")]
	...
	public AddComment()
	{
		...
		// Setup field members
		// 
		System.ComponentModel.ComponentResourceManager _resources_ = new System.ComponentModel.ComponentResourceManager(typeof(AddComment));
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A");
		// 
		// Set component Ids
		// 
		this.SetId(this.labelHost2, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAF22ED8A1665A"));
		this.SetId(this.labelHost3, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAF22ED8A17390"));
		this.SetId(this.labelHost1, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAF22ED8A3C768"));
		this.SetId(this.tryHost1, new OpenSpan.Design.ComponentIdentity("TryHost-8DAF22ED8A3D94E"));
		this.SetId(this.catchHost1, new OpenSpan.Design.ComponentIdentity("CatchHost-8DAF22ED8A3E8A6"));
		this.SetId(this.entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DAF22F17E89674"));
		this.SetId(this.hiddenTypeProxy1, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8DAF22F19BEEE8E"));
		this.SetId(this.hiddenTypeProxy2, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8DAF22F1E4D04C2"));
		this.SetId(this.exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAF230856AD22F"));
		this.SetId(this.exitPoint2, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAF2308AFA1D85"));
		this.SetId(this.exitPoint3, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAF23093EA6A40"));
		this.SetId(this.pause1, new OpenSpan.Design.ComponentIdentity("Pause-8DAF230A236DFBC"));
		this.SetId(this.connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF230A48B0552"));
		this.SetId(this.connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF230AC713BE2"));
		this.SetId(this.connectableMethod3, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF230ADE515AB"));
		this.SetId(this.connectableMethod5, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF230B8972659"));
		this.SetId(this.jumpHost1, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAF230BC410C2C"));
		this.SetId(this.jumpHost2, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAF230BED6BC32"));
		this.SetId(this.connectableMethod6, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE3C67C86D"));
		this.SetId(this.connectableMethod7, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE3C6B7759"));
		this.SetId(this.connectableMethod8, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE3C6EB931"));
		this.SetId(this.connectableMethod9, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE5707C30D"));
		this.SetId(this.connectableMethod10, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE77089A90"));
		this.SetId(this.connectableMethod11, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE770BC48F"));
		this.SetId(this.connectableMethod12, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE770FC3CF"));
		this.SetId(this.connectableMethod13, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE7712E903"));
		this.SetId(this.connectableMethod14, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FF58E69D97"));
		this.SetId(this.connectableMethod15, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FF60231706"));
		this.SetId(this.connectableMethod16, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FF63D03883"));
		this.SetId(this.connectableMethod17, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF3004DB4AD4A"));
		this.SetId(this.connectableMethod18, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF3015973365B"));
		this.SetId(this.connectableMethod19, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF302A260817E"));
		// 
		// AddComment
		// 
		ComponentInfo.CodeDomData = _resources_.GetString("_AddComment_1_");
		dynamicmethodinfo1.BlockTypeName = "OpenSpan.Automation.Design.ConnectionBlocks.EntryPointExecuteBlock";
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_AddComment_2_");
		...
		dynamicmethodinfo2.CodeDomData = _resources_.GetString("_AddComment_3_");
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_AddComment_4_");
		this.labelHost2.DynamicMembers.Add(dynamicmethodinfo2);
		this.labelHost2.DynamicMembers.Add(dynamicpropertyinfo1);
		...
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_AddComment_5_");
		dynamicmethodinfo3.Source = "";
		dynamicmethodinfo3.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo3.CodeDomData = _resources_.GetString("_AddComment_6_");
		...
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_AddComment_7_");
		this.labelHost3.DynamicMembers.Add(dynamicpropertyinfo2);
		this.labelHost3.DynamicMembers.Add(dynamicmethodinfo3);
		this.labelHost3.DynamicMembers.Add(dynamicpropertyinfo3);
		...
		dynamicmethodinfo4.CodeDomData = _resources_.GetString("_AddComment_8_");
		...
		this.tryHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\TryHost-8DAF22ED8A3D94E");
		// 
		// catchHost1
		// 
		...
		dynamiceventinfo1.CodeDomData = _resources_.GetString("_AddComment_9_");
		...
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_AddComment_10_");
		...
		this.catchHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\CatchHost-8DAF22ED8A3E8A6");
		// 
		// entryPoint1
		// 
		...
		// hiddenTypeProxy1
		// 
		this.hiddenTypeProxy1.AliasName = "Comment";
		...
		dynamicpropertyinfo5.CodeDomData = _resources_.GetString("_AddComment_11_");
		...
		// hiddenTypeProxy2
		// 
		this.hiddenTypeProxy2.AliasName = "txtComment";
		...
		dynamicpropertyinfo6.CodeDomData = _resources_.GetString("_AddComment_12_");
		...
		dynamicpropertyinfo7.CodeDomData = _resources_.GetString("_AddComment_13_");
		...
		dynamicpropertyinfo8.CodeDomData = _resources_.GetString("_AddComment_14_");
		...
		dynamicpropertyinfo9.CodeDomData = _resources_.GetString("_AddComment_15_");
		...
		this.entryPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\EntryPoint-8DAF22F17E89674");
		...
		dynamicpropertyinfo10.CodeDomData = _resources_.GetString("_AddComment_16_");
		...
		this.exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\EntryPoint-8DAF22F17E89674");
		// 
		// exitPoint2
		// 
		...
		dynamicpropertyinfo11.CodeDomData = _resources_.GetString("_AddComment_16_");
		...
		this.exitPoint2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\EntryPoint-8DAF22F17E89674");
		// 
		// exitPoint3
		// 
		...
		dynamicpropertyinfo12.CodeDomData = _resources_.GetString("_AddComment_16_");
		...
		this.exitPoint3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\EntryPoint-8DAF22F17E89674");
		// 
		// pause1
		// 
		...
		this.connectableMethod1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		...
		parameterprototype1.DefaultValue = "750";
		...
		this.connectableMethod2.InstanceTypeName = "OpenSpan.Adapters.Controls.TextBox";
		this.connectableMethod2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\HiddenTypeProxy-8DAF22F1E4D04C2");
		...
		this.connectableMethod3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		...
		parameterprototype2.DefaultValue = "750";
		...
		this.connectableMethod5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		...
		parameterprototype3.DefaultValue = "750";
		...
		this.connectableMethod5.MemberPrototypes.Add(memberprototype4);
		...
		this.jumpHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\LabelHost-8DAF22ED8A3C768");
		...
		this.jumpHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\LabelHost-8DAF22ED8A17390");
		...
		this.connectableMethod6.InstanceTypeName = "OpenSpan.Adapters.Controls.Control";
		this.connectableMethod6.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\Control-8DADC317AB75D25");
		memberprototype7.DefaultValue = null;
		memberprototype7.MemberName = "SendKeys";
		...
		parameterprototype6.DefaultValue = "%w";
		parameterprototype6.ParamName = "keys";
		...
		parameterprototype7.ParamName = "focus";
		...
		this.connectableMethod7.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		...
		parameterprototype8.DefaultValue = "500";
		...
		this.connectableMethod8.InstanceTypeName = "OpenSpan.Adapters.Controls.Control";
		this.connectableMethod8.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\Control-8DADC317AB75D25");
		...
		parameterprototype9.DefaultValue = "{DOWN 4}";
		parameterprototype9.ParamName = "keys";
		...
		parameterprototype10.DefaultValue = "True";
		parameterprototype10.ParamName = "focus";
		parameterprototype10.Position = 1;
		parameterprototype10.TypeName = "System.Boolean";
		...
		// connectableMethod9
		// 
		this.connectableMethod9.DisplayName = "<Sleep>";
		this.connectableMethod9.ExceptionsHandled = false;
		this.connectableMethod9.InstanceTypeName = "OpenSpan.Controls.Pause";
		this.connectableMethod9.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		...
		parameterprototype11.DefaultValue = "500";
		parameterprototype11.ParamName = "milliseconds";
		...
		// connectableMethod10
		// 
		this.connectableMethod10.DisplayName = "<SendKeys>";
		this.connectableMethod10.ExceptionsHandled = false;
		this.connectableMethod10.InstanceTypeName = "OpenSpan.Adapters.Controls.Control";
		this.connectableMethod10.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\Control-8DADC317AB75D25");
		memberprototype11.DefaultValue = null;
		memberprototype11.MemberName = "SendKeys";
		...
		parameterprototype12.DefaultValue = "%w";
		parameterprototype12.ParamName = "keys";
		...
		parameterprototype13.DefaultValue = "True";
		parameterprototype13.ParamName = "focus";
		parameterprototype13.Position = 1;
		parameterprototype13.TypeName = "System.Boolean";
		...
		// connectableMethod11
		// 
		this.connectableMethod11.DisplayName = "<Sleep>";
		this.connectableMethod11.ExceptionsHandled = false;
		this.connectableMethod11.InstanceTypeName = "OpenSpan.Controls.Pause";
		this.connectableMethod11.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		...
		parameterprototype14.DefaultValue = "500";
		parameterprototype14.ParamName = "milliseconds";
		parameterprototype14.Position = 0;
		parameterprototype14.TypeName = "System.Int32";
		memberprototype12.Signature.ParameterPrototype.Add(parameterprototype14);
		memberprototype12.Signature.ReturnType = "System.Void";
		memberprototype12.TypeName = "System.Void";
		this.connectableMethod11.MemberPrototypes.Add(memberprototype12);
		this.connectableMethod11.ParamsLength = 0;
		this.connectableMethod11.SerializedParamsDefaultValues = "";
		// 
		// connectableMethod12
		// 
		this.connectableMethod12.DisplayName = "<SendKeys>";
		this.connectableMethod12.ExceptionsHandled = false;
		this.connectableMethod12.InstanceTypeName = "OpenSpan.Adapters.Controls.Control";
		this.connectableMethod12.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\Control-8DADC317AB75D25");
		memberprototype13.DefaultValue = null;
		memberprototype13.MemberName = "SendKeys";
		...
		parameterprototype15.DefaultValue = "{DOWN 5}";
		...
		this.connectableMethod12.MemberPrototypes.Add(memberprototype13);
		this.connectableMethod12.ParamsLength = 0;
		this.connectableMethod12.SerializedParamsDefaultValues = "";
		// 
		// connectableMethod13
		// 
		this.connectableMethod13.DisplayName = "<Sleep>";
		this.connectableMethod13.ExceptionsHandled = false;
		this.connectableMethod13.InstanceTypeName = "OpenSpan.Controls.Pause";
		this.connectableMethod13.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		memberprototype14.DefaultValue = null;
		memberprototype14.MemberName = "Sleep";
		...
		parameterprototype17.DefaultValue = "500";
		parameterprototype17.ParamName = "milliseconds";
		parameterprototype17.Position = 0;
		parameterprototype17.TypeName = "System.Int32";
		memberprototype14.Signature.ParameterPrototype.Add(parameterprototype17);
		memberprototype14.Signature.ReturnType = "System.Void";
		memberprototype14.TypeName = "System.Void";
		this.connectableMethod13.MemberPrototypes.Add(memberprototype14);
		...
		this.connectableMethod14.InstanceTypeName = "OpenSpan.Adapters.Controls.Control";
		this.connectableMethod14.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\Control-8DADC317AB75D25");
		memberprototype15.DefaultValue = null;
		memberprototype15.MemberName = "SendKeys";
		...
		parameterprototype18.DefaultValue = "{ENTER}";
		parameterprototype18.ParamName = "keys";
		...
		parameterprototype19.DefaultValue = "True";
		parameterprototype19.ParamName = "focus";
		parameterprototype19.Position = 1;
		parameterprototype19.TypeName = "System.Boolean";
		...
		this.connectableMethod14.MemberPrototypes.Add(memberprototype15);
		this.connectableMethod14.ParamsLength = 0;
		this.connectableMethod14.SerializedParamsDefaultValues = "";
		// 
		// connectableMethod15
		// 
		this.connectableMethod15.DisplayName = "<SendKeys>";
		this.connectableMethod15.ExceptionsHandled = false;
		this.connectableMethod15.InstanceTypeName = "OpenSpan.Adapters.Controls.Control";
		this.connectableMethod15.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\Control-8DADC317AB75D25");
		memberprototype16.DefaultValue = null;
		memberprototype16.MemberName = "SendKeys";
		...
		parameterprototype20.DefaultValue = "{ENTER}";
		parameterprototype20.ParamName = "keys";
		...
		parameterprototype21.DefaultValue = "True";
		parameterprototype21.ParamName = "focus";
		parameterprototype21.Position = 1;
		parameterprototype21.TypeName = "System.Boolean";
		...
		this.connectableMethod15.MemberPrototypes.Add(memberprototype16);
		...
		this.connectableMethod16.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		memberprototype17.DefaultValue = null;
		memberprototype17.MemberName = "Sleep";
		...
		parameterprototype22.DefaultValue = "500";
		parameterprototype22.ParamName = "milliseconds";
		parameterprototype22.Position = 0;
		parameterprototype22.TypeName = "System.Int32";
		memberprototype17.Signature.ParameterPrototype.Add(parameterprototype22);
		memberprototype17.Signature.ReturnType = "System.Void";
		memberprototype17.TypeName = "System.Void";
		this.connectableMethod16.MemberPrototypes.Add(memberprototype17);
		this.connectableMethod16.ParamsLength = 0;
		this.connectableMethod16.SerializedParamsDefaultValues = "";
		// 
		// connectableMethod17
		// 
		this.connectableMethod17.DisplayName = "<AppendText>";
		this.connectableMethod17.ExceptionsHandled = false;
		this.connectableMethod17.InstanceTypeName = "OpenSpan.Adapters.Controls.TextBox";
		this.connectableMethod17.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\HiddenTypeProxy-8DAF22F1E4D04C2");
		memberprototype18.DefaultValue = null;
		memberprototype18.MemberName = "AppendText";
		...
		parameterprototype23.ParamName = "text";
		parameterprototype23.Position = 0;
		parameterprototype23.TypeName = "System.String";
		memberprototype18.Signature.ParameterPrototype.Add(parameterprototype23);
		memberprototype18.Signature.ReturnType = "System.Void";
		memberprototype18.TypeName = "System.Void";
		this.connectableMethod17.MemberPrototypes.Add(memberprototype18);
		this.connectableMethod17.ParamsLength = 0;
		this.connectableMethod17.SerializedParamsDefaultValues = "";
		// 
		// connectableMethod18
		// 
		this.connectableMethod18.DisplayName = "<Sleep>";
		this.connectableMethod18.ExceptionsHandled = false;
		this.connectableMethod18.InstanceTypeName = "OpenSpan.Controls.Pause";
		this.connectableMethod18.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		memberprototype19.DefaultValue = null;
		memberprototype19.MemberName = "Sleep";
		...
		this.connectableMethod18.MemberPrototypes.Add(memberprototype19);
		this.connectableMethod18.ParamsLength = 0;
		this.connectableMethod18.SerializedParamsDefaultValues = "";
		// 
		// connectableMethod19
		// 
		this.connectableMethod19.DisplayName = "<SendKeys>";
		...
		this.connectableMethod19.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\HiddenTypeProxy-8DAF22F1E4D04C2");
		...
		parameterprototype25.DefaultValue = "^s";
		parameterprototype25.ParamName = "keys";
		...
		parameterprototype26.ParamName = "focus";
		parameterprototype26.Position = 1;
		parameterprototype26.TypeName = "System.Boolean";
		...
		this.connectableMethod19.MemberPrototypes.Add(memberprototype20);
		this.connectableMethod19.ParamsLength = 0;
		this.connectableMethod19.SerializedParamsDefaultValues = "";
		// 
		// Initialize CodeDom data
		// 
		this.CodeDomData = _resources_.GetString("_AddComment_17_");
		// 
		// Add components
		// 
	...
	/// </summary>
	public void Execute(string Comment, OpenSpan.Adapters.Controls.TextBox txtComment)
	{
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost2, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAF22ED8A1665A"));
		labelHost2.DisplayName = "Failed";
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_AddComment_3_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost3, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAF22ED8A17390"));
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_AddComment_5_");
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_AddComment_6_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo2 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_AddComment_7_");
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost1, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAF22ED8A3C768"));
		labelHost1.DisplayName = "Success";
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_AddComment_8_");
	...
	internal OpenSpan.Automation.Design.TryHost Create_tryHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(tryHost1, new OpenSpan.Design.ComponentIdentity("TryHost-8DAF22ED8A3D94E"));
		tryHost1.DisplayName = "TRY";
		tryHost1.ExceptionsHandled = false;
		tryHost1.InstanceTypeName = "OpenSpan.Automation.Design.TryHost";
		tryHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\TryHost-8DAF22ED8A3D94E");
		// 
		// Result
		// 
		return tryHost1;
	...
	internal OpenSpan.Automation.CatchHost Create_catchHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(catchHost1, new OpenSpan.Design.ComponentIdentity("CatchHost-8DAF22ED8A3E8A6"));
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_AddComment_10_");
		...
		catchHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\CatchHost-8DAF22ED8A3E8A6");
		// 
		// Result
		// 
		return catchHost1;
	...
	internal OpenSpan.Automation.EntryPoint Create_entryPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DAF22F17E89674"));
		...
		// hiddenTypeProxy1
		// 
		hiddenTypeProxy1.AliasName = "Comment";
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_AddComment_11_");
		...
		// hiddenTypeProxy2
		// 
		hiddenTypeProxy2.AliasName = "txtComment";
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo2 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_AddComment_12_");
		...
		dynamicpropertyinfo3.ValidateConnectionCallback = null;
		dynamicpropertyinfo3.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_AddComment_13_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo4 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo4.IsSerializable = true;
		dynamicpropertyinfo4.NoInputConvesion = false;
		dynamicpropertyinfo4.Source = "";
		dynamicpropertyinfo4.ValidateConnectionCallback = null;
		dynamicpropertyinfo4.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_AddComment_14_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo5 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo5.IsSerializable = true;
		dynamicpropertyinfo5.NoInputConvesion = false;
		dynamicpropertyinfo5.Source = "";
		dynamicpropertyinfo5.ValidateConnectionCallback = null;
		dynamicpropertyinfo5.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo5.CodeDomData = _resources_.GetString("_AddComment_15_");
		...
		// Set designComp Ids
		// 
		this.SetId(hiddenTypeProxy1, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8DAF22F19BEEE8E"));
		this.SetId(hiddenTypeProxy2, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8DAF22F1E4D04C2"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Automation.HiddenTypeProxy Create_hiddenTypeProxy2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_AddComment_12_");
		...
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_AddComment_11_");
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAF230856AD22F"));
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_AddComment_16_");
		...
		dynamicpropertyinfo3.ValidateConnectionCallback = null;
		dynamicpropertyinfo3.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_AddComment_12_");
		...
		dynamicpropertyinfo4.ValidateConnectionCallback = null;
		dynamicpropertyinfo4.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_AddComment_13_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo5 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo5.IsSerializable = true;
		dynamicpropertyinfo5.NoInputConvesion = false;
		dynamicpropertyinfo5.Source = "";
		dynamicpropertyinfo5.ValidateConnectionCallback = null;
		dynamicpropertyinfo5.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo5.CodeDomData = _resources_.GetString("_AddComment_14_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo6 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo6.IsSerializable = true;
		dynamicpropertyinfo6.NoInputConvesion = false;
		dynamicpropertyinfo6.Source = "";
		dynamicpropertyinfo6.ValidateConnectionCallback = null;
		dynamicpropertyinfo6.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo6.CodeDomData = _resources_.GetString("_AddComment_15_");
		entryPoint1.DynamicMembers.Add(dynamicpropertyinfo4);
		entryPoint1.DynamicMembers.Add(dynamicpropertyinfo5);
		...
		exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\EntryPoint-8DAF22F17E89674");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DAF22F17E89674"));
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint2, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAF2308AFA1D85"));
		...
		exitPoint2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\EntryPoint-8DAF22F17E89674");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DAF22F17E89674"));
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint3, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAF23093EA6A40"));
		...
		exitPoint3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\EntryPoint-8DAF22F17E89674");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DAF22F17E89674"));
	...
	internal OpenSpan.Controls.Pause Create_pause1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(pause1, new OpenSpan.Design.ComponentIdentity("Pause-8DAF230A236DFBC"));
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF230A48B0552"));
		connectableMethod1.DisplayName = "<Sleep>";
		connectableMethod1.ExceptionsHandled = false;
		connectableMethod1.InstanceTypeName = "OpenSpan.Controls.Pause";
		connectableMethod1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Sleep";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF230AC713BE2"));
		connectableMethod2.DisplayName = "<PerformClick>";
		connectableMethod2.ExceptionsHandled = false;
		connectableMethod2.InstanceTypeName = "OpenSpan.Adapters.Controls.TextBox";
		connectableMethod2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\HiddenTypeProxy-8DAF22F1E4D04C2");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod3, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF230ADE515AB"));
		connectableMethod3.DisplayName = "<Sleep>";
		connectableMethod3.ExceptionsHandled = false;
		connectableMethod3.InstanceTypeName = "OpenSpan.Controls.Pause";
		connectableMethod3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Sleep";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod5(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod5, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF230B8972659"));
		...
		connectableMethod5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Sleep";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost1, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAF230BC410C2C"));
		jumpHost1.DisplayName = "<GoToLabel>";
		jumpHost1.ExceptionsHandled = false;
		jumpHost1.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\LabelHost-8DAF22ED8A3C768");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost2, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAF230BED6BC32"));
		jumpHost2.DisplayName = "<GoToLabel>";
		jumpHost2.ExceptionsHandled = false;
		jumpHost2.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\LabelHost-8DAF22ED8A17390");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod6(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod6, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE3C67C86D"));
		connectableMethod6.DisplayName = "<SendKeys>";
		connectableMethod6.ExceptionsHandled = false;
		connectableMethod6.InstanceTypeName = "OpenSpan.Adapters.Controls.Control";
		connectableMethod6.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\Control-8DADC317AB75D25");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod7(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod7, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE3C6B7759"));
		...
		connectableMethod7.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Sleep";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod8(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod8, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE3C6EB931"));
		connectableMethod8.DisplayName = "<SendKeys>";
		connectableMethod8.ExceptionsHandled = false;
		connectableMethod8.InstanceTypeName = "OpenSpan.Adapters.Controls.Control";
		connectableMethod8.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\Control-8DADC317AB75D25");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "SendKeys";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		parameterprototype1.CanWrite = true;
		parameterprototype1.DefaultSet = true;
		parameterprototype1.DefaultValue = "{DOWN 4}";
		parameterprototype1.ParamName = "keys";
		parameterprototype1.Position = 0;
		parameterprototype1.TypeName = "System.String";
		OpenSpan.Automation.ParameterPrototype parameterprototype2 = new OpenSpan.Automation.ParameterPrototype();
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod9(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod9, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE5707C30D"));
		connectableMethod9.DisplayName = "<Sleep>";
		connectableMethod9.ExceptionsHandled = false;
		connectableMethod9.InstanceTypeName = "OpenSpan.Controls.Pause";
		connectableMethod9.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Sleep";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod10(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod10, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE77089A90"));
		connectableMethod10.DisplayName = "<SendKeys>";
		connectableMethod10.ExceptionsHandled = false;
		connectableMethod10.InstanceTypeName = "OpenSpan.Adapters.Controls.Control";
		connectableMethod10.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\Control-8DADC317AB75D25");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "SendKeys";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod11(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod11, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE770BC48F"));
		connectableMethod11.DisplayName = "<Sleep>";
		connectableMethod11.ExceptionsHandled = false;
		connectableMethod11.InstanceTypeName = "OpenSpan.Controls.Pause";
		connectableMethod11.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Sleep";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod12(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod12, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE770FC3CF"));
		connectableMethod12.DisplayName = "<SendKeys>";
		connectableMethod12.ExceptionsHandled = false;
		connectableMethod12.InstanceTypeName = "OpenSpan.Adapters.Controls.Control";
		connectableMethod12.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\Control-8DADC317AB75D25");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "SendKeys";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod13(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod13, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FE7712E903"));
		connectableMethod13.DisplayName = "<Sleep>";
		connectableMethod13.ExceptionsHandled = false;
		connectableMethod13.InstanceTypeName = "OpenSpan.Controls.Pause";
		connectableMethod13.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Sleep";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod14(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod14, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FF58E69D97"));
		connectableMethod14.DisplayName = "<SendKeys>";
		connectableMethod14.ExceptionsHandled = false;
		connectableMethod14.InstanceTypeName = "OpenSpan.Adapters.Controls.Control";
		connectableMethod14.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\Control-8DADC317AB75D25");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "SendKeys";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod15(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod15, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FF60231706"));
		connectableMethod15.DisplayName = "<SendKeys>";
		connectableMethod15.ExceptionsHandled = false;
		connectableMethod15.InstanceTypeName = "OpenSpan.Adapters.Controls.Control";
		connectableMethod15.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("WindowsAdapter-8DADC30F66B21EE\\Control-8DADC317AB75D25");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "SendKeys";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod16(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod16, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF2FF63D03883"));
		...
		connectableMethod16.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Sleep";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod17(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod17, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF3004DB4AD4A"));
		connectableMethod17.DisplayName = "<AppendText>";
		connectableMethod17.ExceptionsHandled = false;
		connectableMethod17.InstanceTypeName = "OpenSpan.Adapters.Controls.TextBox";
		connectableMethod17.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\HiddenTypeProxy-8DAF22F1E4D04C2");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "AppendText";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		OpenSpan.Automation.ParameterPrototype parameterprototype1 = new OpenSpan.Automation.ParameterPrototype();
		parameterprototype1.CanRead = false;
		parameterprototype1.CanWrite = true;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod18(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod18, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF3015973365B"));
		connectableMethod18.DisplayName = "<Sleep>";
		connectableMethod18.ExceptionsHandled = false;
		connectableMethod18.InstanceTypeName = "OpenSpan.Controls.Pause";
		connectableMethod18.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\Pause-8DAF230A236DFBC");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Sleep";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod19(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod19, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAF302A260817E"));
		connectableMethod19.DisplayName = "<SendKeys>";
		connectableMethod19.ExceptionsHandled = false;
		connectableMethod19.InstanceTypeName = "OpenSpan.Adapters.Controls.TextBox";
		connectableMethod19.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAF22ED899211A\\HiddenTypeProxy-8DAF22F1E4D04C2");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "SendKeys";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		parameterprototype1.CanWrite = true;
		parameterprototype1.DefaultSet = true;
		parameterprototype1.DefaultValue = "^s";
		parameterprototype1.ParamName = "keys";
		parameterprototype1.Position = 0;
		parameterprototype1.TypeName = "System.String";
		OpenSpan.Automation.ParameterPrototype parameterprototype2 = new OpenSpan.Automation.ParameterPrototype();
