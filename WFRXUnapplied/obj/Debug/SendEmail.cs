...
[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAD6A2E4B22150")]
...
public sealed class SendEmail : OpenSpan.Automation.Automator
{
	...
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAD6A2E4B22150\\EntryPoint-8DAD6A2E4B53B65")]
	public OpenSpan.Automation.EntryPoint entryPoint1;
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAD6A2E4B22150\\HiddenTypeProxy-8DAEF08EDB856CD")]
	public OpenSpan.Automation.HiddenTypeProxy hiddenTypeProxy1;
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAD6A2E4B22150\\HiddenTypeProxy-8DAEF091A14484A")]
	public OpenSpan.Automation.HiddenTypeProxy hiddenTypeProxy2;
	
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAD6A2E4B22150\\HiddenTypeProxy-8DB03779A129806")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAD6A2E4B22150\\Smtp-8DAD6A2EECD9D86")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAD6A2E4B22150\\StringUtils-8DAE34C4B012BB9")]
	...
	[OpenSpan.Design.ComponentIdentityAttribute("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59")]
	...
	public SendEmail()
	{
		...
		// 
		this.Id = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150");
		// 
		// Set component Ids
		// 
		this.SetId(this.entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DAD6A2E4B53B65"));
		this.SetId(this.hiddenTypeProxy1, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8DAEF08EDB856CD"));
		this.SetId(this.hiddenTypeProxy2, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8DAEF091A14484A"));
		this.SetId(this.hiddenTypeProxy3, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8DB03779A129806"));
		this.SetId(this.exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAD6A2E4B54349"));
		this.SetId(this.exitPoint2, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAD6A2E4B5D8C5"));
		this.SetId(this.exitPoint3, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAD6A2E4B5FE5C"));
		this.SetId(this.labelHost2, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAD6A2E4B9F188"));
		this.SetId(this.labelHost3, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAD6A2E4BA0231"));
		this.SetId(this.labelHost1, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAD6A2E4BC374B"));
		this.SetId(this.tryHost1, new OpenSpan.Design.ComponentIdentity("TryHost-8DAD6A2E4BE9798"));
		this.SetId(this.catchHost1, new OpenSpan.Design.ComponentIdentity("CatchHost-8DAD6A2E4BEBFE7"));
		this.SetId(this.smtp1, new OpenSpan.Design.ComponentIdentity("Smtp-8DAD6A2EECD9D86"));
		this.SetId(this.connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DAD6A3449DD58D"));
		this.SetId(this.connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAD6A374EF693F"));
		this.SetId(this.connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAD6A387975E68"));
		this.SetId(this.jumpHost1, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAD6A38A3C249A"));
		this.SetId(this.jumpHost2, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAD6A38B6D459B"));
		this.SetId(this.stringUtils1, new OpenSpan.Design.ComponentIdentity("StringUtils-8DAE34C4B012BB9"));
		this.SetId(this.connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DAE34C60419A17"));
		this.SetId(this.connectableMethod4, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEEFCB6FB0452"));
		this.SetId(this.connectableProperties5, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DAEEFCC5784405"));
		this.SetId(this.connectableMethod3, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF0904FA61C6"));
		this.SetId(this.connectableMethod5, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF090C1C1D70"));
		this.SetId(this.jsonUtils1, new OpenSpan.Design.ComponentIdentity("JsonUtils-8DAEF0946BA5C59"));
		this.SetId(this.connectableMethod6, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF09494A2AD9"));
		this.SetId(this.connectableProperties3, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DAEF094E994129"));
		this.SetId(this.connectableMethod7, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF09908F658E"));
		this.SetId(this.connectableMethod8, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF0995F1F2C2"));
		this.SetId(this.connectableMethod9, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF099DB10E5D"));
		this.SetId(this.connectableProperties4, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DAEF09DEB4F245"));
		this.SetId(this.connectableMethod10, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF09DEB878D9"));
		this.SetId(this.connectableMethod11, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF09DEBC3728"));
		this.SetId(this.connectableMethod12, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF09DEBF7639"));
		this.SetId(this.connectableMethod13, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF09DEC2C1F8"));
		this.SetId(this.jumpHost3, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAEF09F6ED1DF0"));
		this.SetId(this.connectableProperties6, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB0377A85C0DE4"));
		this.SetId(this.connectableMethod14, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB0377B538F6B5"));
		this.SetId(this.connectableProperties7, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB0377B53CCE73"));
		this.SetId(this.connectableProperties8, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB0377B5404DAC"));
		this.SetId(this.connectableProperties9, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB0377B543DB5E"));
		this.SetId(this.connectableMethod15, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB0377B547989E"));
		this.SetId(this.connectableMethod16, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB0377B54B9989"));
		this.SetId(this.connectableMethod17, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB0377B54FF3EE"));
		this.SetId(this.connectableMethod18, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB0377B553B8BD"));
		this.SetId(this.connectableProperties10, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB0377B55759C6"));
		this.SetId(this.connectableMethod19, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB0377B55B76F1"));
		this.SetId(this.connectableMethod20, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB0377B55F1E12"));
		this.SetId(this.catchHost2, new OpenSpan.Design.ComponentIdentity("CatchHost-8DB0377B5631319"));
		this.SetId(this.jumpHost4, new OpenSpan.Design.ComponentIdentity("JumpHost-8DB0377B566CE72"));
		this.SetId(this.jumpHost5, new OpenSpan.Design.ComponentIdentity("JumpHost-8DB0377B56A9E01"));
		this.SetId(this.connectableMethod21, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB08F51C9F6913"));
		this.SetId(this.connectableProperties11, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB08F52E80E14B"));
		this.SetId(this.connectableProperties12, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB08F53273D6A0"));
		this.SetId(this.connectableProperties13, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB08F54887498C"));
		this.SetId(this.connectableProperties14, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB08F5488C9BBA"));
		this.SetId(this.connectableMethod22, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB08F54890CC2F"));
		this.SetId(this.connectableProperties15, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB08F5541E4C24"));
		this.SetId(this.connectableProperties16, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB08F554226F74"));
		this.SetId(this.connectableMethod23, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB08F55426E3F1"));
		// 
		// SendEmail
		// 
		ComponentInfo.CodeDomData = resources.GetString("_SendEmail_1_");
		this.DocumentScale = 1.150297F;
		dynamicmethodinfo1.BlockTypeName = "OpenSpan.Automation.Design.ConnectionBlocks.EntryPointExecuteBlock";
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicmethodinfo1.CodeDomData = resources.GetString("_SendEmail_2_");
		...
		// hiddenTypeProxy1
		// 
		this.hiddenTypeProxy1.AliasName = "ErrMsg";
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = resources.GetString("_SendEmail_3_");
		...
		// hiddenTypeProxy2
		// 
		this.hiddenTypeProxy2.AliasName = "ReportPath";
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = resources.GetString("_SendEmail_3_");
		...
		// hiddenTypeProxy3
		// 
		this.hiddenTypeProxy3.AliasName = "Finished";
		...
		dynamicpropertyinfo3.CodeDomData = resources.GetString("_SendEmail_4_");
		...
		dynamicpropertyinfo4.CodeDomData = resources.GetString("_SendEmail_5_");
		...
		dynamicpropertyinfo5.CodeDomData = resources.GetString("_SendEmail_6_");
		...
		dynamicpropertyinfo6.CodeDomData = resources.GetString("_SendEmail_7_");
		...
		dynamicpropertyinfo7.CodeDomData = resources.GetString("_SendEmail_8_");
		...
		dynamicpropertyinfo8.CodeDomData = resources.GetString("_SendEmail_9_");
		...
		dynamicpropertyinfo9.CodeDomData = resources.GetString("_SendEmail_10_");
		...
		dynamicpropertyinfo10.CodeDomData = resources.GetString("_SendEmail_11_");
		...
		this.entryPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\EntryPoint-8DAD6A2E4B53B65");
		...
		dynamicpropertyinfo11.CodeDomData = resources.GetString("_SendEmail_12_");
		...
		dynamicpropertyinfo12.CodeDomData = resources.GetString("_SendEmail_13_");
		...
		dynamicpropertyinfo13.CodeDomData = resources.GetString("_SendEmail_14_");
		...
		dynamicpropertyinfo14.CodeDomData = resources.GetString("_SendEmail_15_");
		...
		this.exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\EntryPoint-8DAD6A2E4B53B65");
		// 
		// exitPoint2
		// 
		...
		dynamicpropertyinfo15.CodeDomData = resources.GetString("_SendEmail_12_");
		...
		dynamicpropertyinfo16.CodeDomData = resources.GetString("_SendEmail_13_");
		...
		dynamicpropertyinfo17.CodeDomData = resources.GetString("_SendEmail_14_");
		...
		dynamicpropertyinfo18.CodeDomData = resources.GetString("_SendEmail_15_");
		...
		this.exitPoint2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\EntryPoint-8DAD6A2E4B53B65");
		// 
		// exitPoint3
		// 
		...
		dynamicpropertyinfo19.CodeDomData = resources.GetString("_SendEmail_12_");
		...
		dynamicpropertyinfo20.CodeDomData = resources.GetString("_SendEmail_13_");
		...
		dynamicpropertyinfo21.CodeDomData = resources.GetString("_SendEmail_14_");
		...
		dynamicpropertyinfo22.CodeDomData = resources.GetString("_SendEmail_15_");
		...
		this.exitPoint3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\EntryPoint-8DAD6A2E4B53B65");
		// 
		// labelHost2
		// 
		...
		dynamicmethodinfo2.CodeDomData = resources.GetString("_SendEmail_16_");
		...
		dynamicpropertyinfo23.CodeDomData = resources.GetString("_SendEmail_17_");
		...
		dynamicpropertyinfo24.CodeDomData = resources.GetString("_SendEmail_18_");
		dynamicmethodinfo3.Source = "";
		dynamicmethodinfo3.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo3.CodeDomData = resources.GetString("_SendEmail_19_");
		...
		dynamicpropertyinfo25.CodeDomData = resources.GetString("_SendEmail_20_");
		...
		dynamicmethodinfo4.CodeDomData = resources.GetString("_SendEmail_21_");
		...
		this.tryHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\TryHost-8DAD6A2E4BE9798");
		// 
		// catchHost1
		// 
		...
		dynamiceventinfo1.CodeDomData = resources.GetString("_SendEmail_22_");
		...
		dynamicpropertyinfo26.CodeDomData = resources.GetString("_SendEmail_23_");
		...
		this.catchHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\CatchHost-8DAD6A2E4BEBFE7");
		// 
		// smtp1
		// 
		...
		this.connectableProperties1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\Smtp-8DAD6A2EECD9D86");
		...
		memberprototype5.MemberName = "To";
		...
		// connectableMethod1
		// 
		this.connectableMethod1.DisplayName = "<AddAttachment>";
		this.connectableMethod1.ExceptionsHandled = false;
		this.connectableMethod1.InstanceTypeName = "OpenSpan.Controls.Smtp";
		this.connectableMethod1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\Smtp-8DAD6A2EECD9D86");
		memberprototype6.DefaultValue = null;
		memberprototype6.MemberName = "AddAttachment";
		...
		// connectableMethod2
		// 
		this.connectableMethod2.DisplayName = "<Send>";
		this.connectableMethod2.ExceptionsHandled = false;
		this.connectableMethod2.InstanceTypeName = "OpenSpan.Controls.Smtp";
		this.connectableMethod2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\Smtp-8DAD6A2EECD9D86");
		...
		this.jumpHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\LabelHost-8DAD6A2E4BC374B");
		...
		this.jumpHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\LabelHost-8DAD6A2E4BA0231");
		...
		this.connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\Counter-8DAE34BA4C1F825");
		...
		dynamicpropertyinfo27.CodeDomData = resources.GetString("_SendEmail_24_");
		...
		this.connectableMethod4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\StringUtils-8DAE34C4B012BB9");
		...
		this.connectableMethod4.ParamsLength = 12;
		...
		this.connectableProperties5.InstanceTypeName = "OpenSpan.Controls.Counter";
		this.connectableProperties5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\Counter-8DAE34B39993E3B");
		...
		memberprototype12.TypeName = "System.Int32";
		this.connectableProperties5.MemberPrototypes.Add(memberprototype12);
		// 
		// connectableMethod3
		// 
		this.connectableMethod3.DisplayName = "<IsNullOrEmpty>";
		...
		dynamicpropertyinfo28.CodeDomData = resources.GetString("_SendEmail_25_");
		...
		this.connectableMethod3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\StringUtils-8DAE34C4B012BB9");
		memberprototype13.DefaultValue = null;
		memberprototype13.MemberName = "IsNullOrEmpty";
		...
		this.connectableMethod3.MemberPrototypes.Add(memberprototype13);
		...
		dynamicpropertyinfo29.CodeDomData = resources.GetString("_SendEmail_24_");
		...
		this.connectableMethod5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\StringUtils-8DAE34C4B012BB9");
		...
		parameterprototype6.ParamName = "list";
		parameterprototype6.Position = 0;
		parameterprototype6.TypeName = "System.String[]";
		memberprototype14.Signature.ParameterPrototype.Add(parameterprototype6);
		memberprototype14.Signature.ReturnType = "System.String";
		memberprototype14.TypeName = "System.String";
		this.connectableMethod5.MemberPrototypes.Add(memberprototype14);
		this.connectableMethod5.ParamsLength = 13;
		this.connectableMethod5.SerializedParamsDefaultValues = resources.GetString("connectableMethod5.SerializedParamsDefaultValues");
		// 
		// connectableMethod6
		// 
		...
		dynamicpropertyinfo30.CodeDomData = resources.GetString("_SendEmail_25_");
		this.connectableMethod6.DynamicMembers.Add(dynamicpropertyinfo30);
		this.connectableMethod6.ExceptionsHandled = false;
		this.connectableMethod6.InstanceTypeName = "OpenSpan.Controls.JsonUtils";
		this.connectableMethod6.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		...
		parameterprototype8.DefaultValue = "EmailFrom";
		...
		memberprototype15.Signature.ParameterPrototype.Add(parameterprototype7);
		memberprototype15.Signature.ParameterPrototype.Add(parameterprototype8);
		memberprototype15.Signature.ParameterPrototype.Add(parameterprototype9);
		...
		this.connectableProperties3.MemberPrototypes.Add(memberprototype16);
		// 
		// connectableMethod7
		// 
		this.connectableMethod7.DisplayName = "<GetValueFromJSON>";
		...
		dynamicpropertyinfo31.CodeDomData = resources.GetString("_SendEmail_25_");
		this.connectableMethod7.DynamicMembers.Add(dynamicpropertyinfo31);
		this.connectableMethod7.ExceptionsHandled = false;
		this.connectableMethod7.InstanceTypeName = "OpenSpan.Controls.JsonUtils";
		this.connectableMethod7.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		...
		parameterprototype11.DefaultValue = "EmailFromName";
		...
		dynamicpropertyinfo32.CodeDomData = resources.GetString("_SendEmail_25_");
		...
		this.connectableMethod8.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		...
		parameterprototype14.DefaultValue = "EmailSubject";
		...
		memberprototype18.Signature.ParameterPrototype.Add(parameterprototype15);
		...
		dynamicpropertyinfo33.CodeDomData = resources.GetString("_SendEmail_25_");
		this.connectableMethod9.DynamicMembers.Add(dynamicpropertyinfo33);
		this.connectableMethod9.ExceptionsHandled = false;
		this.connectableMethod9.InstanceTypeName = "OpenSpan.Controls.JsonUtils";
		this.connectableMethod9.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		...
		parameterprototype16.ParamName = "jsonString";
		...
		parameterprototype17.DefaultValue = "EmailTo";
		parameterprototype17.ParamName = "jsonKey";
		...
		parameterprototype18.ParamName = "parsedValue";
		parameterprototype18.Position = 2;
		parameterprototype18.TypeName = "System.String";
		memberprototype19.Signature.ParameterPrototype.Add(parameterprototype16);
		...
		this.connectableProperties4.InstanceTypeName = "OpenSpan.Controls.Smtp";
		this.connectableProperties4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\Smtp-8DAD6A2EECD9D86");
		memberprototype20.DefaultValue = null;
		memberprototype20.MemberName = "Body";
		...
		memberprototype21.MemberName = "From";
		...
		memberprototype22.MemberName = "FromName";
		...
		memberprototype23.MemberName = "Subject";
		...
		memberprototype24.MemberName = "To";
		...
		this.connectableProperties4.MemberPrototypes.Add(memberprototype21);
		this.connectableProperties4.MemberPrototypes.Add(memberprototype22);
		this.connectableProperties4.MemberPrototypes.Add(memberprototype23);
		this.connectableProperties4.MemberPrototypes.Add(memberprototype24);
		// 
		// connectableMethod10
		// 
		...
		dynamicpropertyinfo34.CodeDomData = resources.GetString("_SendEmail_25_");
		...
		this.connectableMethod10.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		...
		parameterprototype19.ParamName = "jsonString";
		...
		parameterprototype20.DefaultValue = "EmailFrom";
		parameterprototype20.ParamName = "jsonKey";
		...
		parameterprototype21.ParamName = "parsedValue";
		parameterprototype21.Position = 2;
		parameterprototype21.TypeName = "System.String";
		memberprototype25.Signature.ParameterPrototype.Add(parameterprototype19);
		memberprototype25.Signature.ParameterPrototype.Add(parameterprototype20);
		...
		dynamicpropertyinfo35.CodeDomData = resources.GetString("_SendEmail_25_");
		...
		this.connectableMethod11.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		...
		parameterprototype22.ParamName = "jsonString";
		...
		parameterprototype23.DefaultValue = "EmailFromName";
		parameterprototype23.ParamName = "jsonKey";
		...
		parameterprototype24.ParamName = "parsedValue";
		...
		memberprototype26.Signature.ParameterPrototype.Add(parameterprototype24);
		...
		dynamicpropertyinfo36.CodeDomData = resources.GetString("_SendEmail_25_");
		...
		this.connectableMethod12.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		memberprototype27.DefaultValue = null;
		memberprototype27.MemberName = "GetValueFromJSON";
		...
		parameterprototype25.ParamName = "jsonString";
		...
		parameterprototype26.DefaultValue = "EmailSubject";
		parameterprototype26.ParamName = "jsonKey";
		...
		parameterprototype27.ParamName = "parsedValue";
		parameterprototype27.Position = 2;
		parameterprototype27.TypeName = "System.String";
		memberprototype27.Signature.ParameterPrototype.Add(parameterprototype25);
		memberprototype27.Signature.ParameterPrototype.Add(parameterprototype26);
		memberprototype27.Signature.ParameterPrototype.Add(parameterprototype27);
		...
		dynamicpropertyinfo37.CodeDomData = resources.GetString("_SendEmail_25_");
		...
		this.connectableMethod13.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		memberprototype28.DefaultValue = null;
		memberprototype28.MemberName = "GetValueFromJSON";
		...
		parameterprototype29.DefaultValue = "EmailTo";
		...
		memberprototype28.Signature.ParameterPrototype.Add(parameterprototype28);
		memberprototype28.Signature.ParameterPrototype.Add(parameterprototype29);
		memberprototype28.Signature.ParameterPrototype.Add(parameterprototype30);
		...
		this.jumpHost3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\LabelHost-8DAD6A2E4B9F188");
		...
		parameterprototype31.DefaultValue = "Email info is not configured in ReferenceData file. ";
		parameterprototype31.ParamName = "_param1";
		parameterprototype31.Position = 0;
		parameterprototype31.TypeName = "System.String";
		memberprototype29.Signature.ParameterPrototype.Add(parameterprototype31);
		memberprototype29.Signature.ReturnType = "System.Void";
		memberprototype29.TypeName = "System.Void";
		this.jumpHost3.MemberPrototypes.Add(memberprototype29);
		...
		this.connectableProperties6.InstanceTypeName = "System.Boolean";
		this.connectableProperties6.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\HiddenTypeProxy-8DB03779A129806");
		...
		this.connectableProperties6.MemberPrototypes.Add(memberprototype30);
		// 
		// connectableMethod14
		// 
		...
		dynamicpropertyinfo38.CodeDomData = resources.GetString("_SendEmail_24_");
		...
		this.connectableMethod14.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\StringUtils-8DAE34C4B012BB9");
		memberprototype31.DefaultValue = null;
		memberprototype31.MemberName = "Concat";
		...
		memberprototype31.Signature.ParameterPrototype.Add(parameterprototype32);
		memberprototype31.Signature.ReturnType = "System.String";
		memberprototype31.TypeName = "System.String";
		this.connectableMethod14.MemberPrototypes.Add(memberprototype31);
		this.connectableMethod14.ParamsLength = 13;
		this.connectableMethod14.SerializedParamsDefaultValues = resources.GetString("connectableMethod14.SerializedParamsDefaultValues");
		// 
		...
		this.connectableProperties7.InstanceTypeName = "OpenSpan.Controls.Counter";
		this.connectableProperties7.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\Counter-8DAE34BA4C1F825");
		...
		this.connectableProperties7.MemberPrototypes.Add(memberprototype32);
		// 
		...
		this.connectableProperties8.InstanceTypeName = "OpenSpan.Controls.Counter";
		this.connectableProperties8.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\Counter-8DAE34B39993E3B");
		...
		this.connectableProperties8.MemberPrototypes.Add(memberprototype33);
		// 
		...
		this.connectableProperties9.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\StringVariable-8DAD392E5477D27");
		...
		this.connectableProperties9.MemberPrototypes.Add(memberprototype34);
		// 
		// connectableMethod15
		// 
		...
		dynamicpropertyinfo39.CodeDomData = resources.GetString("_SendEmail_25_");
		...
		this.connectableMethod15.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		...
		parameterprototype33.ParamName = "jsonString";
		...
		parameterprototype34.DefaultValue = "EmailFrom";
		parameterprototype34.ParamName = "jsonKey";
		...
		parameterprototype35.ParamName = "parsedValue";
		parameterprototype35.Position = 2;
		parameterprototype35.TypeName = "System.String";
		memberprototype35.Signature.ParameterPrototype.Add(parameterprototype33);
		memberprototype35.Signature.ParameterPrototype.Add(parameterprototype34);
		memberprototype35.Signature.ParameterPrototype.Add(parameterprototype35);
		...
		dynamicpropertyinfo40.CodeDomData = resources.GetString("_SendEmail_25_");
		...
		this.connectableMethod16.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		memberprototype36.DefaultValue = null;
		memberprototype36.MemberName = "GetValueFromJSON";
		...
		parameterprototype36.ParamName = "jsonString";
		...
		parameterprototype37.DefaultValue = "EmailFromName";
		parameterprototype37.ParamName = "jsonKey";
		...
		parameterprototype38.ParamName = "parsedValue";
		parameterprototype38.Position = 2;
		parameterprototype38.TypeName = "System.String";
		memberprototype36.Signature.ParameterPrototype.Add(parameterprototype36);
		memberprototype36.Signature.ParameterPrototype.Add(parameterprototype37);
		memberprototype36.Signature.ParameterPrototype.Add(parameterprototype38);
		...
		dynamicpropertyinfo41.CodeDomData = resources.GetString("_SendEmail_25_");
		this.connectableMethod17.DynamicMembers.Add(dynamicpropertyinfo41);
		this.connectableMethod17.ExceptionsHandled = false;
		this.connectableMethod17.InstanceTypeName = "OpenSpan.Controls.JsonUtils";
		this.connectableMethod17.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		...
		parameterprototype40.DefaultValue = "EmailSubject";
		...
		this.connectableMethod17.MemberPrototypes.Add(memberprototype37);
		...
		dynamicpropertyinfo42.CodeDomData = resources.GetString("_SendEmail_25_");
		...
		this.connectableMethod18.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		...
		parameterprototype42.ParamName = "jsonString";
		...
		parameterprototype43.DefaultValue = "EmailTo";
		parameterprototype43.ParamName = "jsonKey";
		parameterprototype43.Position = 1;
		parameterprototype43.TypeName = "System.String";
		parameterprototype44.CanRead = true;
		parameterprototype44.CanWrite = false;
		parameterprototype44.DefaultSet = false;
		parameterprototype44.DefaultValue = null;
		parameterprototype44.ParamName = "parsedValue";
		...
		this.connectableProperties10.InstanceTypeName = "OpenSpan.Controls.Smtp";
		this.connectableProperties10.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\Smtp-8DAD6A2EECD9D86");
		memberprototype39.DefaultValue = null;
		memberprototype39.MemberName = "Body";
		...
		memberprototype40.MemberName = "From";
		...
		memberprototype41.MemberName = "FromName";
		...
		memberprototype42.MemberName = "Subject";
		...
		memberprototype43.MemberName = "To";
		...
		this.connectableProperties10.MemberPrototypes.Add(memberprototype39);
		this.connectableProperties10.MemberPrototypes.Add(memberprototype40);
		this.connectableProperties10.MemberPrototypes.Add(memberprototype41);
		this.connectableProperties10.MemberPrototypes.Add(memberprototype42);
		this.connectableProperties10.MemberPrototypes.Add(memberprototype43);
		// 
		// connectableMethod19
		// 
		this.connectableMethod19.DisplayName = "<AddAttachment>";
		this.connectableMethod19.ExceptionsHandled = false;
		this.connectableMethod19.InstanceTypeName = "OpenSpan.Controls.Smtp";
		this.connectableMethod19.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\Smtp-8DAD6A2EECD9D86");
		memberprototype44.DefaultValue = null;
		memberprototype44.MemberName = "AddAttachment";
		...
		parameterprototype45.DefaultValue = "filename";
		parameterprototype45.ParamName = "filename";
		parameterprototype45.Position = 0;
		parameterprototype45.TypeName = "System.String";
		memberprototype44.Signature.ParameterPrototype.Add(parameterprototype45);
		...
		// connectableMethod20
		// 
		this.connectableMethod20.DisplayName = "<Send>";
		this.connectableMethod20.ExceptionsHandled = false;
		this.connectableMethod20.InstanceTypeName = "OpenSpan.Controls.Smtp";
		this.connectableMethod20.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\Smtp-8DAD6A2EECD9D86");
		memberprototype45.DefaultValue = null;
		memberprototype45.MemberName = "Send";
		...
		this.connectableMethod20.MemberPrototypes.Add(memberprototype45);
		...
		this.catchHost2.CaughtLinkIDs.Add(138);
		...
		dynamiceventinfo2.CodeDomData = resources.GetString("_SendEmail_22_");
		...
		dynamicpropertyinfo43.CodeDomData = resources.GetString("_SendEmail_23_");
		this.catchHost2.DynamicMembers.Add(dynamiceventinfo2);
		this.catchHost2.DynamicMembers.Add(dynamicpropertyinfo43);
		this.catchHost2.ExceptionsHandled = false;
		this.catchHost2.InstanceTypeName = "OpenSpan.Automation.CatchHost";
		this.catchHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\CatchHost-8DB0377B5631319");
		// 
		// jumpHost4
		// 
		...
		this.jumpHost4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\LabelHost-8DAD6A2E4BC374B");
		...
		this.jumpHost4.MemberPrototypes.Add(memberprototype46);
		...
		this.jumpHost5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\LabelHost-8DAD6A2E4BA0231");
		...
		memberprototype47.Signature.ParameterPrototype.Add(parameterprototype46);
		memberprototype47.Signature.ParameterPrototype.Add(parameterprototype47);
		memberprototype47.Signature.ReturnType = "System.Void";
		memberprototype47.TypeName = "System.Void";
		this.jumpHost5.MemberPrototypes.Add(memberprototype47);
		this.jumpHost5.ParamsLength = 0;
		this.jumpHost5.SerializedParamsDefaultValues = "";
		// 
		// connectableMethod21
		// 
		this.connectableMethod21.DisplayName = "<Concat>";
		...
		dynamicpropertyinfo44.CodeDomData = resources.GetString("_SendEmail_24_");
		this.connectableMethod21.DynamicMembers.Add(dynamicpropertyinfo44);
		this.connectableMethod21.ExceptionsHandled = false;
		this.connectableMethod21.InstanceTypeName = "OpenSpan.Controls.StringUtils";
		this.connectableMethod21.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\StringUtils-8DAE34C4B012BB9");
		memberprototype48.DefaultValue = null;
		memberprototype48.MemberName = "Concat";
		...
		parameterprototype48.ParamName = "list";
		parameterprototype48.Position = 0;
		parameterprototype48.TypeName = "System.String[]";
		memberprototype48.Signature.ParameterPrototype.Add(parameterprototype48);
		...
		this.connectableMethod21.ParamsLength = 6;
		this.connectableMethod21.SerializedParamsDefaultValues = resources.GetString("_SendEmail_26_");
		// 
		...
		this.connectableProperties11.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\StringVariable-8DB0789AE9DB496");
		...
		this.connectableProperties11.MemberPrototypes.Add(memberprototype49);
		// 
		...
		this.connectableProperties12.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\StringVariable-8DB0789AFAD8404");
		...
		this.connectableProperties12.MemberPrototypes.Add(memberprototype50);
		// 
		...
		this.connectableProperties13.MemberPrototypes.Add(memberprototype51);
		// 
		...
		this.connectableProperties14.MemberPrototypes.Add(memberprototype52);
		// 
		// connectableMethod22
		// 
		this.connectableMethod22.DisplayName = "<Concat>";
		...
		dynamicpropertyinfo45.CodeDomData = resources.GetString("_SendEmail_24_");
		this.connectableMethod22.DynamicMembers.Add(dynamicpropertyinfo45);
		this.connectableMethod22.ExceptionsHandled = false;
		this.connectableMethod22.InstanceTypeName = "OpenSpan.Controls.StringUtils";
		this.connectableMethod22.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\StringUtils-8DAE34C4B012BB9");
		memberprototype53.DefaultValue = null;
		memberprototype53.MemberName = "Concat";
		...
		parameterprototype49.ParamName = "list";
		...
		memberprototype53.Signature.ReturnType = "System.String";
		memberprototype53.TypeName = "System.String";
		this.connectableMethod22.MemberPrototypes.Add(memberprototype53);
		this.connectableMethod22.ParamsLength = 6;
		this.connectableMethod22.SerializedParamsDefaultValues = resources.GetString("_SendEmail_26_");
		// 
		...
		this.connectableProperties15.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\StringVariable-8DB0789AE9DB496");
		...
		this.connectableProperties15.MemberPrototypes.Add(memberprototype54);
		// 
		...
		this.connectableProperties16.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\StringVariable-8DB0789AFAD8404");
		...
		this.connectableProperties16.MemberPrototypes.Add(memberprototype55);
		// 
		// connectableMethod23
		// 
		...
		dynamicpropertyinfo46.CodeDomData = resources.GetString("_SendEmail_24_");
		this.connectableMethod23.DynamicMembers.Add(dynamicpropertyinfo46);
		this.connectableMethod23.ExceptionsHandled = false;
		this.connectableMethod23.InstanceTypeName = "OpenSpan.Controls.StringUtils";
		this.connectableMethod23.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\StringUtils-8DAE34C4B012BB9");
		memberprototype56.DefaultValue = null;
		memberprototype56.MemberName = "Concat";
		...
		parameterprototype50.ParamName = "list";
		parameterprototype50.Position = 0;
		parameterprototype50.TypeName = "System.String[]";
		memberprototype56.Signature.ParameterPrototype.Add(parameterprototype50);
		memberprototype56.Signature.ReturnType = "System.String";
		memberprototype56.TypeName = "System.String";
		this.connectableMethod23.MemberPrototypes.Add(memberprototype56);
		this.connectableMethod23.ParamsLength = 6;
		this.connectableMethod23.SerializedParamsDefaultValues = resources.GetString("_SendEmail_26_");
		// 
		// Initialize CodeDom data
		// 
		this.CodeDomData = resources.GetString("_SendEmail_27_");
		// 
		// Add components
		// 
	...
	/// </summary>
	public void Execute(string ErrMsg, string ReportPath, bool Finished, out string Ex, out string Msg, out string Automation)
	{
		Ex = default(string);
		Msg = default(string);
	...
	internal OpenSpan.Automation.EntryPoint Create_entryPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DAD6A2E4B53B65"));
		...
		// hiddenTypeProxy1
		// 
		hiddenTypeProxy1.AliasName = "ErrMsg";
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		...
		// hiddenTypeProxy2
		// 
		hiddenTypeProxy2.AliasName = "ReportPath";
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo2 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		...
		// hiddenTypeProxy3
		// 
		hiddenTypeProxy3.AliasName = "Finished";
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo3 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo3.IsSerializable = true;
		dynamicpropertyinfo3.NoInputConvesion = false;
		dynamicpropertyinfo3.Source = "";
		dynamicpropertyinfo3.ValidateConnectionCallback = null;
		dynamicpropertyinfo3.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_SendEmail_4_");
		...
		dynamicpropertyinfo4.ValidateConnectionCallback = null;
		dynamicpropertyinfo4.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_SendEmail_5_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo5 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo5.IsSerializable = true;
		dynamicpropertyinfo5.NoInputConvesion = false;
		dynamicpropertyinfo5.Source = "";
		dynamicpropertyinfo5.ValidateConnectionCallback = null;
		dynamicpropertyinfo5.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo5.CodeDomData = _resources_.GetString("_SendEmail_6_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo6 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo6.IsSerializable = true;
		dynamicpropertyinfo6.NoInputConvesion = false;
		dynamicpropertyinfo6.Source = "";
		dynamicpropertyinfo6.ValidateConnectionCallback = null;
		dynamicpropertyinfo6.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo6.CodeDomData = _resources_.GetString("_SendEmail_7_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo7 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo7.IsSerializable = true;
		dynamicpropertyinfo7.NoInputConvesion = false;
		dynamicpropertyinfo7.Source = "";
		dynamicpropertyinfo7.ValidateConnectionCallback = null;
		dynamicpropertyinfo7.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo7.CodeDomData = _resources_.GetString("_SendEmail_8_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo8 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo8.IsSerializable = true;
		dynamicpropertyinfo8.NoInputConvesion = false;
		dynamicpropertyinfo8.Source = "";
		dynamicpropertyinfo8.ValidateConnectionCallback = null;
		dynamicpropertyinfo8.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo8.CodeDomData = _resources_.GetString("_SendEmail_9_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo9 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo9.IsSerializable = true;
		dynamicpropertyinfo9.NoInputConvesion = false;
		dynamicpropertyinfo9.Source = "";
		dynamicpropertyinfo9.ValidateConnectionCallback = null;
		dynamicpropertyinfo9.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo9.CodeDomData = _resources_.GetString("_SendEmail_10_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo10 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo10.IsSerializable = true;
		dynamicpropertyinfo10.NoInputConvesion = false;
		dynamicpropertyinfo10.Source = "";
		dynamicpropertyinfo10.ValidateConnectionCallback = null;
		dynamicpropertyinfo10.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo10.CodeDomData = _resources_.GetString("_SendEmail_11_");
		...
		// Set designComp Ids
		// 
		this.SetId(hiddenTypeProxy1, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8DAEF08EDB856CD"));
		this.SetId(hiddenTypeProxy2, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8DAEF091A14484A"));
		this.SetId(hiddenTypeProxy3, new OpenSpan.Design.ComponentIdentity("HiddenTypeProxy-8DB03779A129806"));
		// 
		// Add components
		// 
	...
	internal OpenSpan.Automation.HiddenTypeProxy Create_hiddenTypeProxy3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_SendEmail_4_");
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint1, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAD6A2E4B54349"));
		...
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_SendEmail_12_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo2 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_SendEmail_13_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo3 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo3.IsSerializable = true;
		dynamicpropertyinfo3.NoInputConvesion = false;
		dynamicpropertyinfo3.Source = "";
		dynamicpropertyinfo3.ValidateConnectionCallback = null;
		dynamicpropertyinfo3.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo3.CodeDomData = _resources_.GetString("_SendEmail_14_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo4 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo4.IsSerializable = true;
		dynamicpropertyinfo4.NoInputConvesion = false;
		dynamicpropertyinfo4.Source = "";
		dynamicpropertyinfo4.ValidateConnectionCallback = null;
		dynamicpropertyinfo4.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo4.CodeDomData = _resources_.GetString("_SendEmail_15_");
		...
		dynamicpropertyinfo7.ValidateConnectionCallback = null;
		dynamicpropertyinfo7.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo7.CodeDomData = _resources_.GetString("_SendEmail_4_");
		...
		dynamicpropertyinfo8.ValidateConnectionCallback = null;
		dynamicpropertyinfo8.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo8.CodeDomData = _resources_.GetString("_SendEmail_5_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo9 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo9.IsSerializable = true;
		dynamicpropertyinfo9.NoInputConvesion = false;
		dynamicpropertyinfo9.Source = "";
		dynamicpropertyinfo9.ValidateConnectionCallback = null;
		dynamicpropertyinfo9.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo9.CodeDomData = _resources_.GetString("_SendEmail_6_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo10 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo10.IsSerializable = true;
		dynamicpropertyinfo10.NoInputConvesion = false;
		dynamicpropertyinfo10.Source = "";
		dynamicpropertyinfo10.ValidateConnectionCallback = null;
		dynamicpropertyinfo10.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo10.CodeDomData = _resources_.GetString("_SendEmail_7_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo11 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo11.IsSerializable = true;
		dynamicpropertyinfo11.NoInputConvesion = false;
		dynamicpropertyinfo11.Source = "";
		...
		dynamicpropertyinfo11.CodeDomData = _resources_.GetString("_SendEmail_8_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo12 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo12.IsSerializable = true;
		dynamicpropertyinfo12.NoInputConvesion = false;
		dynamicpropertyinfo12.Source = "";
		dynamicpropertyinfo12.ValidateConnectionCallback = null;
		dynamicpropertyinfo12.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo12.CodeDomData = _resources_.GetString("_SendEmail_9_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo13 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo13.IsSerializable = true;
		dynamicpropertyinfo13.NoInputConvesion = false;
		dynamicpropertyinfo13.Source = "";
		dynamicpropertyinfo13.ValidateConnectionCallback = null;
		dynamicpropertyinfo13.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo13.CodeDomData = _resources_.GetString("_SendEmail_10_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo14 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo14.IsSerializable = true;
		dynamicpropertyinfo14.NoInputConvesion = false;
		dynamicpropertyinfo14.Source = "";
		dynamicpropertyinfo14.ValidateConnectionCallback = null;
		dynamicpropertyinfo14.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo14.CodeDomData = _resources_.GetString("_SendEmail_11_");
		entryPoint1.DynamicMembers.Add(dynamicpropertyinfo8);
		entryPoint1.DynamicMembers.Add(dynamicpropertyinfo9);
		entryPoint1.DynamicMembers.Add(dynamicpropertyinfo10);
		...
		exitPoint1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\EntryPoint-8DAD6A2E4B53B65");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DAD6A2E4B53B65"));
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint2, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAD6A2E4B5D8C5"));
		...
		exitPoint2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\EntryPoint-8DAD6A2E4B53B65");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DAD6A2E4B53B65"));
	...
	internal OpenSpan.Automation.ExitPoint Create_exitPoint3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(exitPoint3, new OpenSpan.Design.ComponentIdentity("ExitPoint-8DAD6A2E4B5FE5C"));
		...
		exitPoint3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\EntryPoint-8DAD6A2E4B53B65");
		// 
		// Set designComp Ids
		// 
		this.SetId(entryPoint1, new OpenSpan.Design.ComponentIdentity("EntryPoint-8DAD6A2E4B53B65"));
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost2, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAD6A2E4B9F188"));
		labelHost2.DisplayName = "Failed";
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_SendEmail_16_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost3, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAD6A2E4BA0231"));
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_SendEmail_18_");
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_SendEmail_19_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo2 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo2.IsSerializable = true;
		dynamicpropertyinfo2.NoInputConvesion = false;
		dynamicpropertyinfo2.Source = "";
		dynamicpropertyinfo2.ValidateConnectionCallback = null;
		dynamicpropertyinfo2.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicpropertyinfo2.CodeDomData = _resources_.GetString("_SendEmail_20_");
	...
	internal OpenSpan.Automation.LabelHost Create_labelHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(labelHost1, new OpenSpan.Design.ComponentIdentity("LabelHost-8DAD6A2E4BC374B"));
		labelHost1.DisplayName = "Success";
		OpenSpan.DynamicMembers.DynamicMethodInfo dynamicmethodinfo1 = new OpenSpan.DynamicMembers.DynamicMethodInfo();
		dynamicmethodinfo1.Source = "";
		dynamicmethodinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamicmethodinfo1.CodeDomData = _resources_.GetString("_SendEmail_21_");
	...
	internal OpenSpan.Automation.Design.TryHost Create_tryHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(tryHost1, new OpenSpan.Design.ComponentIdentity("TryHost-8DAD6A2E4BE9798"));
		tryHost1.DisplayName = "TRY";
		tryHost1.ExceptionsHandled = false;
		tryHost1.InstanceTypeName = "OpenSpan.Automation.Design.TryHost";
		tryHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\TryHost-8DAD6A2E4BE9798");
		// 
		// Result
		// 
		return tryHost1;
	...
	internal OpenSpan.Automation.CatchHost Create_catchHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(catchHost1, new OpenSpan.Design.ComponentIdentity("CatchHost-8DAD6A2E4BEBFE7"));
		...
		dynamiceventinfo1.Source = "";
		dynamiceventinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.AlwaysHidden;
		dynamiceventinfo1.CodeDomData = _resources_.GetString("_SendEmail_22_");
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		...
		catchHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\CatchHost-8DAD6A2E4BEBFE7");
		// 
		// Result
		// 
		return catchHost1;
	...
	internal OpenSpan.Controls.Smtp Create_smtp1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(smtp1, new OpenSpan.Design.ComponentIdentity("Smtp-8DAD6A2EECD9D86"));
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties1, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DAD6A3449DD58D"));
		connectableProperties1.DefaultValues = "";
		connectableProperties1.DisplayName = "Properties";
		connectableProperties1.ExceptionsHandled = false;
		connectableProperties1.InstanceTypeName = "OpenSpan.Controls.Smtp";
		connectableProperties1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\Smtp-8DAD6A2EECD9D86");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Body";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod1, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAD6A374EF693F"));
		connectableMethod1.DisplayName = "<AddAttachment>";
		connectableMethod1.ExceptionsHandled = false;
		connectableMethod1.InstanceTypeName = "OpenSpan.Controls.Smtp";
		connectableMethod1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\Smtp-8DAD6A2EECD9D86");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod2, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAD6A387975E68"));
		connectableMethod2.DisplayName = "<Send>";
		connectableMethod2.ExceptionsHandled = false;
		connectableMethod2.InstanceTypeName = "OpenSpan.Controls.Smtp";
		connectableMethod2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\Smtp-8DAD6A2EECD9D86");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost1, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAD6A38A3C249A"));
		jumpHost1.DisplayName = "<GoToLabel>";
		jumpHost1.ExceptionsHandled = false;
		jumpHost1.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost1.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\LabelHost-8DAD6A2E4BC374B");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost2, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAD6A38B6D459B"));
		jumpHost2.DisplayName = "<GoToLabel>";
		jumpHost2.ExceptionsHandled = false;
		jumpHost2.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\LabelHost-8DAD6A2E4BA0231");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Controls.StringUtils Create_stringUtils1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(stringUtils1, new OpenSpan.Design.ComponentIdentity("StringUtils-8DAE34C4B012BB9"));
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties2, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DAE34C60419A17"));
		connectableProperties2.DefaultValues = "";
		connectableProperties2.DisplayName = "Properties";
		connectableProperties2.ExceptionsHandled = false;
		connectableProperties2.InstanceTypeName = "OpenSpan.Controls.Counter";
		connectableProperties2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\Counter-8DAE34BA4C1F825");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod4(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod4, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEEFCB6FB0452"));
		...
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicpropertyinfo1.CodeDomData = resources.GetString("_SendEmail_24_");
		...
		connectableMethod4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\StringUtils-8DAE34C4B012BB9");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		...
		connectableMethod4.ParamsLength = 12;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties5(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties5, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DAEEFCC5784405"));
		...
		connectableProperties5.InstanceTypeName = "OpenSpan.Controls.Counter";
		connectableProperties5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\Counter-8DAE34B39993E3B");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Value";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod3, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF0904FA61C6"));
		connectableMethod3.DisplayName = "<IsNullOrEmpty>";
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		dynamicpropertyinfo1.ValidateConnectionCallback = null;
		dynamicpropertyinfo1.Visibility = OpenSpan.TypeManagement.MemberVisibilityLevel.DefaultOn;
		dynamicpropertyinfo1.CodeDomData = _resources_.GetString("_SendEmail_25_");
		...
		connectableMethod3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\StringUtils-8DAE34C4B012BB9");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod5(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod5, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF090C1C1D70"));
		...
		connectableMethod5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\StringUtils-8DAE34C4B012BB9");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Concat";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		connectableMethod5.ParamsLength = 13;
		connectableMethod5.SerializedParamsDefaultValues = resources.GetString("connectableMethod5.SerializedParamsDefaultValues");
		// 
		// Result
		// 
	...
	internal OpenSpan.Controls.JsonUtils Create_jsonUtils1(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jsonUtils1, new OpenSpan.Design.ComponentIdentity("JsonUtils-8DAEF0946BA5C59"));
		// 
		// Result
		// 
		return jsonUtils1;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod6(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod6, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF09494A2AD9"));
		...
		connectableMethod6.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		...
		parameterprototype2.DefaultValue = "EmailFrom";
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties3, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DAEF094E994129"));
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod7(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod7, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF09908F658E"));
		connectableMethod7.DisplayName = "<GetValueFromJSON>";
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		...
		connectableMethod7.InstanceTypeName = "OpenSpan.Controls.JsonUtils";
		connectableMethod7.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GetValueFromJSON";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		parameterprototype2.CanWrite = true;
		parameterprototype2.DefaultSet = true;
		parameterprototype2.DefaultValue = "EmailFromName";
		parameterprototype2.ParamName = "jsonKey";
		parameterprototype2.Position = 1;
		parameterprototype2.TypeName = "System.String";
		OpenSpan.Automation.ParameterPrototype parameterprototype3 = new OpenSpan.Automation.ParameterPrototype();
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod8(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod8, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF0995F1F2C2"));
		...
		connectableMethod8.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GetValueFromJSON";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		parameterprototype2.CanWrite = true;
		parameterprototype2.DefaultSet = true;
		parameterprototype2.DefaultValue = "EmailSubject";
		parameterprototype2.ParamName = "jsonKey";
		parameterprototype2.Position = 1;
		parameterprototype2.TypeName = "System.String";
		OpenSpan.Automation.ParameterPrototype parameterprototype3 = new OpenSpan.Automation.ParameterPrototype();
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod9(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod9, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF099DB10E5D"));
		...
		connectableMethod9.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GetValueFromJSON";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		parameterprototype2.CanWrite = true;
		parameterprototype2.DefaultSet = true;
		parameterprototype2.DefaultValue = "EmailTo";
		parameterprototype2.ParamName = "jsonKey";
		parameterprototype2.Position = 1;
		parameterprototype2.TypeName = "System.String";
		OpenSpan.Automation.ParameterPrototype parameterprototype3 = new OpenSpan.Automation.ParameterPrototype();
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties4(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties4, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DAEF09DEB4F245"));
		...
		connectableProperties4.InstanceTypeName = "OpenSpan.Controls.Smtp";
		connectableProperties4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\Smtp-8DAD6A2EECD9D86");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Body";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
		...
		connectableProperties4.MemberPrototypes.Add(memberprototype3);
		connectableProperties4.MemberPrototypes.Add(memberprototype4);
		connectableProperties4.MemberPrototypes.Add(memberprototype5);
		// 
		// Result
		// 
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod10(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod10, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF09DEB878D9"));
		...
		connectableMethod10.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GetValueFromJSON";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod11(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod11, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF09DEBC3728"));
		...
		connectableMethod11.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GetValueFromJSON";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod12(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod12, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF09DEBF7639"));
		...
		connectableMethod12.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GetValueFromJSON";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod13(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod13, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DAEF09DEC2C1F8"));
		...
		connectableMethod13.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GetValueFromJSON";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost3(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost3, new OpenSpan.Design.ComponentIdentity("JumpHost-8DAEF09F6ED1DF0"));
		jumpHost3.DisplayName = "<GoToLabel>";
		jumpHost3.ExceptionsHandled = false;
		jumpHost3.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost3.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\LabelHost-8DAD6A2E4B9F188");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		parameterprototype1.DefaultValue = "Email info is not configured in ReferenceData file. ";
		parameterprototype1.ParamName = "_param1";
		parameterprototype1.Position = 0;
		parameterprototype1.TypeName = "System.String";
		memberprototype1.Signature.ParameterPrototype.Add(parameterprototype1);
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties6(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties6, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB0377A85C0DE4"));
		...
		connectableProperties6.InstanceTypeName = "System.Boolean";
		connectableProperties6.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\HiddenTypeProxy-8DB03779A129806");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod14(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod14, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB0377B538F6B5"));
		...
		connectableMethod14.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\StringUtils-8DAE34C4B012BB9");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Concat";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		connectableMethod14.ParamsLength = 13;
		connectableMethod14.SerializedParamsDefaultValues = resources.GetString("connectableMethod14.SerializedParamsDefaultValues");
		// 
		// Result
		// 
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties7(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties7, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB0377B53CCE73"));
		...
		connectableProperties7.InstanceTypeName = "OpenSpan.Controls.Counter";
		connectableProperties7.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\Counter-8DAE34BA4C1F825");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Value";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties8(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties8, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB0377B5404DAC"));
		...
		connectableProperties8.InstanceTypeName = "OpenSpan.Controls.Counter";
		connectableProperties8.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\Counter-8DAE34B39993E3B");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Value";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties9(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties9, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB0377B543DB5E"));
		...
		connectableProperties9.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\StringVariable-8DAD392E5477D27");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Value";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod15(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod15, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB0377B547989E"));
		...
		connectableMethod15.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GetValueFromJSON";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod16(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod16, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB0377B54B9989"));
		...
		connectableMethod16.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GetValueFromJSON";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod17(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod17, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB0377B54FF3EE"));
		...
		connectableMethod17.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GetValueFromJSON";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod18(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod18, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB0377B553B8BD"));
		...
		connectableMethod18.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\JsonUtils-8DAEF0946BA5C59");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GetValueFromJSON";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties10(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties10, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB0377B55759C6"));
		...
		connectableProperties10.InstanceTypeName = "OpenSpan.Controls.Smtp";
		connectableProperties10.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\Smtp-8DAD6A2EECD9D86");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Body";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
		...
		connectableProperties10.MemberPrototypes.Add(memberprototype2);
		connectableProperties10.MemberPrototypes.Add(memberprototype3);
		connectableProperties10.MemberPrototypes.Add(memberprototype4);
		connectableProperties10.MemberPrototypes.Add(memberprototype5);
		// 
		// Result
		// 
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod19(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod19, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB0377B55B76F1"));
		connectableMethod19.DisplayName = "<AddAttachment>";
		connectableMethod19.ExceptionsHandled = false;
		connectableMethod19.InstanceTypeName = "OpenSpan.Controls.Smtp";
		connectableMethod19.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\Smtp-8DAD6A2EECD9D86");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "AddAttachment";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod20(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod20, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB0377B55F1E12"));
		connectableMethod20.DisplayName = "<Send>";
		connectableMethod20.ExceptionsHandled = false;
		connectableMethod20.InstanceTypeName = "OpenSpan.Controls.Smtp";
		connectableMethod20.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\Smtp-8DAD6A2EECD9D86");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Send";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.CatchHost Create_catchHost2(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(catchHost2, new OpenSpan.Design.ComponentIdentity("CatchHost-8DB0377B5631319"));
		...
		catchHost2.CaughtLinkIDs.Add(138);
		...
		catchHost2.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\CatchHost-8DB0377B5631319");
		// 
		// Result
		// 
		return catchHost2;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost4(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost4, new OpenSpan.Design.ComponentIdentity("JumpHost-8DB0377B566CE72"));
		jumpHost4.DisplayName = "<GoToLabel>";
		jumpHost4.ExceptionsHandled = false;
		jumpHost4.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost4.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\LabelHost-8DAD6A2E4BC374B");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.JumpHost Create_jumpHost5(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(jumpHost5, new OpenSpan.Design.ComponentIdentity("JumpHost-8DB0377B56A9E01"));
		jumpHost5.DisplayName = "<GoToLabel>";
		jumpHost5.ExceptionsHandled = false;
		jumpHost5.InstanceTypeName = "OpenSpan.Automation.LabelHost";
		jumpHost5.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\LabelHost-8DAD6A2E4BA0231");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "GoToLabel";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod21(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod21, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB08F51C9F6913"));
		connectableMethod21.DisplayName = "<Concat>";
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		...
		connectableMethod21.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\StringUtils-8DAE34C4B012BB9");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Concat";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		connectableMethod21.ParamsLength = 6;
		connectableMethod21.SerializedParamsDefaultValues = _resources_.GetString("_SendEmail_26_");
		// 
		// Result
		// 
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties11(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties11, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB08F52E80E14B"));
		...
		connectableProperties11.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\StringVariable-8DB0789AE9DB496");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Value";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties12(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties12, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB08F53273D6A0"));
		...
		connectableProperties12.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\StringVariable-8DB0789AFAD8404");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Value";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties13(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties13, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB08F54887498C"));
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties14(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties14, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB08F5488C9BBA"));
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod22(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod22, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB08F54890CC2F"));
		connectableMethod22.DisplayName = "<Concat>";
		OpenSpan.DynamicMembers.DynamicPropertyInfo dynamicpropertyinfo1 = new OpenSpan.DynamicMembers.DynamicPropertyInfo();
		dynamicpropertyinfo1.IsSerializable = true;
		dynamicpropertyinfo1.NoInputConvesion = false;
		dynamicpropertyinfo1.Source = "";
		...
		connectableMethod22.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\StringUtils-8DAE34C4B012BB9");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Concat";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		connectableMethod22.ParamsLength = 6;
		connectableMethod22.SerializedParamsDefaultValues = _resources_.GetString("_SendEmail_26_");
		// 
		// Result
		// 
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties15(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties15, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB08F5541E4C24"));
		...
		connectableProperties15.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\StringVariable-8DB0789AE9DB496");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Value";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
	...
	internal OpenSpan.Automation.ConnectableProperties Create_connectableProperties16(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableProperties16, new OpenSpan.Design.ComponentIdentity("ConnectableProperties-8DB08F554226F74"));
		...
		connectableProperties16.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("GlobalContainer-8DAD2DFEC79FDA4\\StringVariable-8DB0789AFAD8404");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Value";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Property;
	...
	internal OpenSpan.Automation.ConnectableMethod Create_connectableMethod23(out System.Collections.Generic.ICollection<System.ComponentModel.IComponent> components)
	{
		...
		this.SetId(connectableMethod23, new OpenSpan.Design.ComponentIdentity("ConnectableMethod-8DB08F55426E3F1"));
		...
		connectableMethod23.InstanceUniqueId = new OpenSpan.Design.ComponentIdentity("Automator-8DAD6A2E4B22150\\StringUtils-8DAE34C4B012BB9");
		OpenSpan.Automation.MemberPrototype memberprototype1 = new OpenSpan.Automation.MemberPrototype();
		memberprototype1.DefaultValue = null;
		memberprototype1.MemberName = "Concat";
		memberprototype1.MemberType = System.Reflection.MemberTypes.Method;
		...
		connectableMethod23.ParamsLength = 6;
		connectableMethod23.SerializedParamsDefaultValues = _resources_.GetString("_SendEmail_26_");
		// 
		// Result
		// 
